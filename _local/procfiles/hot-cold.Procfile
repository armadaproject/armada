...
lookouthcui: sh -c 'until [ -f internal/lookoutui/node_modules/.yarn-integrity ]; do echo "Waiting for lookoutui install..."; sleep 2; done && cd internal/lookoutui && VITE_PORT=3001 PROXY_TARGET=http://localhost:8091 VITE_CACHE_DIR=node_modules/.vite-hc yarn dev'
