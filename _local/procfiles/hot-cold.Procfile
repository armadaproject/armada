...
lookoutui: sh -c 'cd internal/lookoutui && rm -f .openapi-ready && yarn install && yarn run openapi && rm -rf node_modules/.vite node_modules/.vite-hc && touch .openapi-ready && VITE_PORT=3000 PROXY_TARGET=http://localhost:8089 yarn dev'
