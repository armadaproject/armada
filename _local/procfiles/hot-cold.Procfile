...
lookouthcui: sh -c 'rm -f internal/lookoutui/.openapi-ready && until [ -f internal/lookoutui/.openapi-ready ]; do echo "Waiting for openapi generation..."; sleep 2; done && cd internal/lookoutui && VITE_PORT=3001 PROXY_TARGET=http://localhost:8091 VITE_CACHE_DIR=node_modules/.vite-hc yarn dev'
