...
<div
  ...
  style={{
    background:
      'radial-gradient(ellipse at 50% -20%, rgba(0, 169, 225, 0.3) 0%, transparent 65%)',
  }}
/>

<div className='text-fd-foreground mb-2 text-2xl font-semibold'>Need help?</div>

<div className='text-fd-muted-foreground mb-6 max-w-lg text-sm'>
...
<div className='flex flex-wrap justify-center gap-3'>
  <a
    ...
    target='_blank'
    className='bg-fd-primary rounded-lg px-3.5 py-2 text-sm font-medium text-white no-underline transition-all hover:opacity-90 hover:shadow-lg hover:shadow-black/20 dark:hover:shadow-white/20'
  >
  ...
  <a
    ...
    target='_blank'
    className='text-fd-muted-foreground border-fd-border hover:border-fd-foreground flex items-center gap-2 rounded-lg border px-3.5 py-2 text-sm font-semibold no-underline transition-all hover:shadow-lg hover:shadow-black/20 focus:outline-none dark:hover:shadow-white/20'
  >
    <svg
