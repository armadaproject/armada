...
Armada bundles a web UI referred to as Lookout. To understand its components see the [Relationships Diagram](../relationships-diagram.mdx).
...
See [the README for the Lookout UI](https://github.com/armadaproject/armada/tree/master/internal/lookoutui) for more information about UI development.
