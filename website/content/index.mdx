...
<div className='relative flex flex-col items-center text-center my-8 py-8 px-8 border border-fd-border rounded-xl overflow-hidden not-prose'>
    ...
    <a
      ...
      target='_blank'
      className='rounded-lg px-3.5 py-2 font-semibold text-sm text-fd-muted-foreground border border-fd-border no-underline transition-all hover:border-fd-foreground hover:shadow-lg hover:shadow-black/20 dark:hover:shadow-white/20 focus:outline-none'
    >
