...
- [Armada API](./api.mdx)
- [Running Armada in an EC2 Instance](./aws-ec2.mdx)
- [Armada UI](./ui.mdx)
- [Usage Metrics](./usage-metrics.mdx)
- [Using OIDC with Armada](./oidc.mdx)
- [Building the Website](./website.mdx)
- [Using Localdev Manually](./manual-localdev.mdx)
  {/* - [Inspecting and Debugging etcd in Localdev setup](./etc-localdev.mdx) */}
...
For more information see the [UI Developer Guide](./ui.mdx).
...
See the [Manually Running LocalDev](./manual-localdev.mdx) guide for more information.
