    ...
    <div className="cancel-job-sets-container">
      ...
      <Fragment>
        <p className="cancel-job-sets-text">
          The following Job Sets were cancelled successfully:
        </p>
      ...
      <Fragment>
        <p className="cancel-job-sets-text">
          Some Job Sets failed to cancel:
        </p>
            ...
            <TableBody className="cancel-job-sets-failure">
              {props.cancelJobSetsResult.failedJobSetCancellations.map(failedCancellation => (
                <TableRow key={failedCancellation.jobSet.jobSetId}>
                  <TableCell className="cancel-job-sets-id cancel-job-sets-wrap">{failedCancellation.jobSet.jobSetId}</TableCell>
                  <TableCell className="cancel-job-sets-error cancel-job-sets-wrap">{failedCancellation.error}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
