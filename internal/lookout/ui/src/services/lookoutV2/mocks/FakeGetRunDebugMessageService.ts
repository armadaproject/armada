...
import {IGetRunDebugMessageService} from "../GetRunDebugMessageService";

export class FakeGetRunDebugMessageService implements IGetRunDebugMessageService {
  constructor(private simulateApiWait = true) {}

  async getRunDebugMessage(runId: string, signal?: AbortSignal): Promise<string> {
