...
CREATE TABLE IF NOT EXISTS jobs (
  ...
  queue                SimpleAggregateFunction(any, LowCardinality(Nullable(String))),
  namespace            SimpleAggregateFunction(any, LowCardinality(Nullable(String))),
  ...
  priority_class       SimpleAggregateFunction(any, LowCardinality(Nullable(String))),
  annotations          SimpleAggregateFunction(any, Map(String, String)),
  job_state            SimpleAggregateFunction(anyLast, LowCardinality(Nullable(String))),
...
CREATE TABLE IF NOT EXISTS job_runs (
  ...
  cluster     SimpleAggregateFunction(anyLast, LowCardinality(Nullable(String))),
  exit_code   SimpleAggregateFunction(anyLast, Nullable(Int32)),
  state       SimpleAggregateFunction(anyLast, LowCardinality(Nullable(String))),
  run_node    SimpleAggregateFunction(anyLast, LowCardinality(Nullable(String))),
