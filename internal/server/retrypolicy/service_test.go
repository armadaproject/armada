...
func TestCreateRetryPolicy_PermissionDenied(t *testing.T) {
	...
	m.expectAuthorizeAction(ctx, permissions.CreateRetryPolicy, &armadaerrors.ErrUnauthorized{Principal: "alice", Permission: "create_retry_policy"})
...
func TestCreateRetryPolicy_AuthorizeErrorUnavailable(t *testing.T) {
	...
	m.expectAuthorizeAction(ctx, permissions.CreateRetryPolicy, errors.New("authorizer down"))
...
func TestCreateRetryPolicy_AlreadyExists(t *testing.T) {
	...
	m.expectAuthorizeAction(ctx, permissions.CreateRetryPolicy, nil)
...
func TestCreateRetryPolicy_InvalidPolicyRejected(t *testing.T) {
	...
	// The policy lacks a default action, so ValidatePolicy rejects it. No repo
	// expectation is set: gomock fails the test if the repository is called.
	_, err := s.CreateRetryPolicy(ctx, &api.RetryPolicy{Name: "p1"})
...
func TestUpdateRetryPolicy_PermissionDenied(t *testing.T) {
	...
	m.expectAuthorizeAction(ctx, permissions.UpdateRetryPolicy, &armadaerrors.ErrUnauthorized{Principal: "alice", Permission: "update_retry_policy"})
...
func TestUpdateRetryPolicy_NotFound(t *testing.T) {
	...
	m.expectAuthorizeAction(ctx, permissions.UpdateRetryPolicy, nil)
...
func TestDeleteRetryPolicy_PermissionDenied(t *testing.T) {
	...
	m.expectAuthorizeAction(ctx, permissions.DeleteRetryPolicy, &armadaerrors.ErrUnauthorized{Principal: "alice", Permission: "delete_retry_policy"})
