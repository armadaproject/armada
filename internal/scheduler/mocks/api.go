...
// Source: github.com/armadaproject/armada/pkg/api (interfaces: SubmitClient,Submit_GetQueuesClient,RetryPolicyServiceClient)
//
// Generated by this command:
//
//	mockgen -destination=./api.go -package=schedulermocks github.com/armadaproject/armada/pkg/api SubmitClient,Submit_GetQueuesClient,RetryPolicyServiceClient
//
...
// MockRetryPolicyServiceClient is a mock of RetryPolicyServiceClient interface.
type MockRetryPolicyServiceClient struct {
	ctrl     *gomock.Controller
	recorder *MockRetryPolicyServiceClientMockRecorder
	isgomock struct{}
}

// MockRetryPolicyServiceClientMockRecorder is the mock recorder for MockRetryPolicyServiceClient.
type MockRetryPolicyServiceClientMockRecorder struct {
	mock *MockRetryPolicyServiceClient
}

// NewMockRetryPolicyServiceClient creates a new mock instance.
func NewMockRetryPolicyServiceClient(ctrl *gomock.Controller) *MockRetryPolicyServiceClient {
	mock := &MockRetryPolicyServiceClient{ctrl: ctrl}
	mock.recorder = &MockRetryPolicyServiceClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRetryPolicyServiceClient) EXPECT() *MockRetryPolicyServiceClientMockRecorder {
	return m.recorder
}

// CreateRetryPolicy mocks base method.
func (m *MockRetryPolicyServiceClient) CreateRetryPolicy(ctx context.Context, in *api.RetryPolicy, opts ...grpc.CallOption) (*types.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CreateRetryPolicy", varargs...)
	ret0, _ := ret[0].(*types.Empty)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRetryPolicyServiceClientMockRecorder) CreateRetryPolicy(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRetryPolicy", reflect.TypeOf((*MockRetryPolicyServiceClient)(nil).CreateRetryPolicy), varargs...)
}

// DeleteRetryPolicy mocks base method.
func (m *MockRetryPolicyServiceClient) DeleteRetryPolicy(ctx context.Context, in *api.RetryPolicyDeleteRequest, opts ...grpc.CallOption) (*types.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DeleteRetryPolicy", varargs...)
	ret0, _ := ret[0].(*types.Empty)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRetryPolicyServiceClientMockRecorder) DeleteRetryPolicy(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteRetryPolicy", reflect.TypeOf((*MockRetryPolicyServiceClient)(nil).DeleteRetryPolicy), varargs...)
}

// GetRetryPolicies mocks base method.
func (m *MockRetryPolicyServiceClient) GetRetryPolicies(ctx context.Context, in *api.RetryPolicyListRequest, opts ...grpc.CallOption) (*api.RetryPolicyList, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetRetryPolicies", varargs...)
	ret0, _ := ret[0].(*api.RetryPolicyList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetRetryPolicies indicates an expected call of GetRetryPolicies.
func (mr *MockRetryPolicyServiceClientMockRecorder) GetRetryPolicies(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRetryPolicies", reflect.TypeOf((*MockRetryPolicyServiceClient)(nil).GetRetryPolicies), varargs...)
}

// GetRetryPolicy mocks base method.
func (m *MockRetryPolicyServiceClient) GetRetryPolicy(ctx context.Context, in *api.RetryPolicyGetRequest, opts ...grpc.CallOption) (*api.RetryPolicy, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetRetryPolicy", varargs...)
...
func (mr *MockRetryPolicyServiceClientMockRecorder) GetRetryPolicy(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRetryPolicy", reflect.TypeOf((*MockRetryPolicyServiceClient)(nil).GetRetryPolicy), varargs...)
}

// UpdateRetryPolicy mocks base method.
func (m *MockRetryPolicyServiceClient) UpdateRetryPolicy(ctx context.Context, in *api.RetryPolicy, opts ...grpc.CallOption) (*types.Empty, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "UpdateRetryPolicy", varargs...)
	ret0, _ := ret[0].(*types.Empty)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRetryPolicyServiceClientMockRecorder) UpdateRetryPolicy(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRetryPolicy", reflect.TypeOf((*MockRetryPolicyServiceClient)(nil).UpdateRetryPolicy), varargs...)
}
