...
//go:generate mockgen -destination=./mock_repositories.go -package=schedulermocks "github.com/G-Research/armada/internal/scheduler/database" ExecutorRepository,QueueRepository
