...
func NewNodeEvictor(
	...
	return &Evictor{
		...
		nodeFilter: func(_ context.Context, node *nodedb.Node) bool {
...
func defaultPostEvictFunc(ctx context.Context, job interfaces.LegacySchedulerJob, node *nodedb.Node) {
