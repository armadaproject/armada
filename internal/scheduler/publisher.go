...
type Publisher interface {
	...
	PublishMessages(ctx *context.ArmadaContext, events []*armadaevents.EventSequence, shouldPublish func() bool) error
	...
	PublishMarkers(ctx *context.ArmadaContext, groupId uuid.UUID) (uint32, error)
}
...
func (p *PulsarPublisher) PublishMessages(ctx *context.ArmadaContext, events []*armadaevents.EventSequence, shouldPublish func() bool) error {
...
func (p *PulsarPublisher) PublishMarkers(ctx *context.ArmadaContext, groupId uuid.UUID) (uint32, error) {
