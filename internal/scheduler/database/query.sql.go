...
UPDATE jobs SET cancel_requested = true, cancel_user = COALESCE(cancel_user, $1) WHERE queue = $2 and job_set = $3 and job_id = ANY($4::text[]) and terminated = false
`
...
UPDATE jobs SET cancel_by_jobset_requested = true, cancel_user = COALESCE(cancel_user, $1) WHERE job_set = $2 and queue = $3 and terminated = false
`
...
UPDATE jobs SET cancel_by_jobset_requested = true, cancel_user = COALESCE(cancel_user, $1) WHERE job_set = $2 and queue = $3 and queued = ANY($4::bool[]) and terminated = false
`
