...
type PoolSchedulingErrorType string

const (
	PoolSchedulingErrorTypeContextCreation PoolSchedulingErrorType = "context_creation"
	PoolSchedulingErrorTypeSchedule        PoolSchedulingErrorType = "schedule"
	PoolSchedulingErrorTypeUpsert          PoolSchedulingErrorType = "upsert"
)
...
type PoolSchedulingOutcome struct {
	Pool              string
	Success           bool
	ErrorType         PoolSchedulingErrorType
