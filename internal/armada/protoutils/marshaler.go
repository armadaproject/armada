// Copied from https://github.com/cockroachdb/cockroach/blob/master/pkg/util/protoutil/jsonpb_marshal.go
// As we don't want to bring this dependency in
// Fixes problem of combining gogo & gRPC Gateway (https://github.com/gogo/protobuf/issues/212)
