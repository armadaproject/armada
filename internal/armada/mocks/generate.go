...
//go:generate mockgen -destination=./mock_respository.go -package=mocks "github.com/armadaproject/armada/internal/armada/repository" QueueRepository,JobRepository
