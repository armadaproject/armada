  ...
  it("does not change valid preferences", () => {
    ...
    const expected: JobsTablePreferences = {
      ...
      visibleColumns: {
        ...
        [StandardColumnId.State]: false,
        [StandardColumnId.Count]: false,
        [StandardColumnId.Priority]: false,
        [StandardColumnId.Owner]: false,
        [StandardColumnId.CPU]: false,
        [StandardColumnId.Memory]: false,
        [StandardColumnId.EphemeralStorage]: false,
        [StandardColumnId.GPU]: false,
        [StandardColumnId.PriorityClass]: false,
        [StandardColumnId.LastTransitionTimeUtc]: false,
        [StandardColumnId.TimeSubmittedUtc]: false,
        [StandardColumnId.TimeSubmittedAgo]: false,
        [StandardColumnId.Node]: false,
        [StandardColumnId.Cluster]: false,
        [StandardColumnId.Pool]: false,
        [StandardColumnId.ExitCode]: false,
        [StandardColumnId.RuntimeSeconds]: false,
        [StandardColumnId.FailureCategory]: false,
        [StandardColumnId.FailureSubcategory]: false,
      },
    }
