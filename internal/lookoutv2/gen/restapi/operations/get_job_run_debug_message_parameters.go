...
func NewGetJobRunDebugMessageParams() GetJobRunDebugMessageParams {
	...
	return GetJobRunDebugMessageParams{}
}

// GetJobRunDebugMessageParams contains all the bound params for the get job run debug message operation
...
func (o *GetJobRunDebugMessageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		...
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			...
			if len(res) == 0 {
				o.GetJobRunDebugMessageRequest = body
			}
		}
	} else {
		res = append(res, errors.Required("getJobRunDebugMessageRequest", "body", ""))
