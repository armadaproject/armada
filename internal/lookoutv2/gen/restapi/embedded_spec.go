  ...
  "paths": {
    ...
    "/api/v1/jobs/{jobId}/report": {
      "get": {
        ...
        "summary": "Get the most recent scheduling report for each executor for a job by job ID",
        "operationId": "getJobReportById",
        "parameters": [
          {
            "type": "string",
            "name": "jobId",
    ...
    "/api/v1/queues/{queueName}/report": {
      "get": {
        "produces": [
          "text/plain"
        ],
        "summary": "Get the most recent scheduling report for each executor for a queue by queue name",
        "operationId": "getQueueReportByName",
        "parameters": [
          {
            "type": "string",
            "name": "queueName",
          ...
          },
          {
            "type": "integer",
            "default": 0,
            "description": "Verbosity level of the queue report.",
            "name": "verbosity",
            "in": "query"
          }
        ],
    ...
    "/api/v1/schedulingReport": {
      "get": {
        "produces": [
          "text/plain"
        ],
        "summary": "Get scheduler reports",
        "operationId": "getSchedulingReport",
        "parameters": [
          {
            "type": "integer",
            "default": 0,
            "description": "Verbosity level of the scheduler reports.",
            "name": "verbosity",
            "in": "query"
          }
        ],
