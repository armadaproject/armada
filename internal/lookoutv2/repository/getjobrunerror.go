...
func NewSqlGetJobRunErrorRepository(db *pgxpool.Pool, decompressor compress.Decompressor) *SqlGetJobSpecRepository {
...
func (r *SqlGetJobSpecRepository) GetJobRunError(ctx context.Context, runId string) (string, error) {
	var rawBytes []byte
