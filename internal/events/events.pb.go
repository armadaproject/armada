...
type EventSequence struct {
	...
	QueueJobSetHash []byte `protobuf:"bytes,3,opt,name=queue_job_set_hash,json=queueJobSetHash,proto3" json:"queue_job_set_hash,omitempty"`
...
func (m *EventSequence) GetQueueJobSetHash() []byte {
	if m != nil {
		return m.QueueJobSetHash
	}
	return nil
}
...
type ObjectMeta struct {
	...
	KubernetesId string            `protobuf:"bytes,3,opt,name=kubernetesId,proto3" json:"kubernetesId,omitempty"`
...
func (*JobRunErrors) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{20}
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{21}
}
...
func (*KubernetesError) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{22}
}
...
func (*ApplicationError) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{23}
}
...
func (*ExecutorError) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{24}
}
...
func (*JobUnschedulable) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{25}
}
...
func (*LeaseExpired) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{26}
}
...
func (*JobPreempted) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{27}
}
...
func (*MaxRunsExceeded) Descriptor() ([]byte, []int) {
	return fileDescriptor_a7740d41e030ef3b, []int{28}
}
...
var fileDescriptor_a7740d41e030ef3b = []byte{
	...
	,
}
...
func (m *EventSequence) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.QueueJobSetHash) > 0 {
		i -= len(m.QueueJobSetHash)
		copy(dAtA[i:], m.QueueJobSetHash)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.QueueJobSetHash)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *EventSequence) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QueueJobSetHash", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QueueJobSetHash = append(m.QueueJobSetHash[:0], dAtA[iNdEx:postIndex]...)
			if m.QueueJobSetHash == nil {
				m.QueueJobSetHash = []byte{}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
