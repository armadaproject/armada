...
type ObjectMeta struct {
	...
	// UUID assigned to the object my Kubernetes.
	// Should be left empty on job creation, but should be set when in the JobRunRunning message.
...
// Message containing a set of errors associated with a particular job (or job run).
// Contains a flag, which if set to true indicates that the job (or job run) has failed.
// Otherwise, this message represents a set of errors from which the system has recovered.
type JobErrors struct {
	// Id of the job this error is associated with.
	JobId string `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`
...
type JobRunErrors struct {
	RunId string `protobuf:"bytes,1,opt,name=run_id,json=runId,proto3" json:"run_id,omitempty"`
	// If provided, this set of errors occurred within the context of a particular job run.
	// If omitted, this set of errors occurred outside the context of a job run (e.g., during scheduling by Armada).
	JobId string `protobuf:"bytes,2,opt,name=job_id,json=jobId,proto3" json:"job_id,omitempty"`
	// If true, this set of errors represent an unrecoverable failure.
	// If run_id is set and terminal is true, the executor has given up on this job run.
	// If run_id is not set and terminal is true, Armada has given up on this job and will not create more runs for it.
...
func (m *KubernetesError) GetResourceId() string {
	if m != nil {
		return m.ResourceId
	}
	return ""
...
func (m *ApplicationError) GetContainerId() string {
	if m != nil {
...
var fileDescriptor_a7740d41e030ef3b = []byte{
	...
	,
}
