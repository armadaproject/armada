...
type JobRunLease struct {
	...
	// Scheduling metadata from the scheduler (gang info, node placement).
	SchedulingMetadata *armadaevents.SchedulingMetadata `protobuf:"bytes,8,opt,name=scheduling_metadata,json=schedulingMetadata,proto3" json:"schedulingMetadata,omitempty"`
}
...
func (m *JobRunLease) GetSchedulingMetadata() *armadaevents.SchedulingMetadata {
	if m != nil {
...
var fileDescriptor_57e0d9d0e484e459 = []byte{
	...
	,
}
...
func (m *JobRunLease) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.SchedulingMetadata == nil {
				m.SchedulingMetadata = &armadaevents.SchedulingMetadata{}
			}
