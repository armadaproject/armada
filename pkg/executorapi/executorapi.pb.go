...
type LeaseRequest struct {
	...
	ResourceUsageByQueue map[string]*ResourceUsage `protobuf:"bytes,7,rep,name=resource_usage_by_queue,json=resourceUsageByQueue,proto3" json:"resourceUsageByQueue,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *LeaseRequest) GetResourceUsageByQueue() map[string]*ResourceUsage {
	if m != nil {
...
type ResourceUsage struct {
	...
	// This is real usage and not just the allocated value
	ResourcesUsed map[string]resource.Quantity `protobuf:"bytes,1,rep,name=resources_used,json=resourcesUsed,proto3" json:"resourcesUsed" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *ResourceUsage) GetResourcesUsed() map[string]resource.Quantity {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*ResourceUsage)(nil), "executorapi.LeaseRequest.ResourceUsageByQueueEntry")
	proto.RegisterMapType((map[string]resource.Quantity)(nil), "executorapi.LeaseRequest.ResourcesEntry")
	proto.RegisterType((*ResourceUsage)(nil), "executorapi.ResourceUsage")
	proto.RegisterMapType((map[string]resource.Quantity)(nil), "executorapi.ResourceUsage.ResourcesUsedEntry")
...
var fileDescriptor_57e0d9d0e484e459 = []byte{
	...
	,
}
...
func (this *LeaseRequest) String() string {
	...
	mapStringForResourceUsageByQueue := "map[string]*ResourceUsage{"
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.ResourceUsageByQueue == nil {
				m.ResourceUsageByQueue = make(map[string]*ResourceUsage)
			}
			var mapkey string
			var mapvalue *ResourceUsage
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
