...
type JobRunLease struct {
	...
	// job_run_index is the zero-based attempt counter for this run within its job.
	// Wrapped to give explicit presence: nil means the scheduler did not populate
	// the field (legacy scheduler or feature flag off), so the executor must use
	// the legacy pod-name format. Non-nil means the executor must include the
	// index as a suffix in the pod name to disambiguate retry attempts.
	JobRunIndex *types.UInt32Value `protobuf:"bytes,8,opt,name=job_run_index,json=jobRunIndex,proto3" json:"jobRunIndex,omitempty"`
}
...
func (m *JobRunLease) GetJobRunIndex() *types.UInt32Value {
	if m != nil {
		return m.JobRunIndex
	}
	return nil
}
...
var fileDescriptor_57e0d9d0e484e459 = []byte{
	...
	,
}
...
func (m *JobRunLease) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.JobRunIndex != nil {
		{
			size, err := m.JobRunIndex.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *JobRunLease) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JobRunIndex", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.JobRunIndex == nil {
				m.JobRunIndex = &types.UInt32Value{}
			}
			if err := m.JobRunIndex.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
