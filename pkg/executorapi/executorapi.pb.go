...
type NodeInfo struct {
	...
	// Resources available for allocation is given by the difference between this and non_armada_allocated_resources.
	...
	// Deprecated in favour of non_armada_allocated_resources_total
	NonArmadaAllocatedResources map[int32]*ComputeResource `protobuf:"bytes,9,rep,name=non_armada_allocated_resources,json=nonArmadaAllocatedResources,proto3" json:"nonArmadaAllocatedResources,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Deprecated: Do not use.
	...
	ResourceUsageByQueueAndPool []*PoolQueueResource `protobuf:"bytes,14,rep,name=resource_usage_by_queue_and_pool,json=resourceUsageByQueueAndPool,proto3" json:"resourceUsageByQueueAndPool,omitempty"`
	// The amount of resource allocated to non-armada pods
	NonArmadaAllocatedResourcesTotal map[string]*resource.Quantity `protobuf:"bytes,15,rep,name=non_armada_allocated_resources_total,json=nonArmadaAllocatedResourcesTotal,proto3" json:"nonArmadaAllocatedResourcesTotal,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *NodeInfo) GetResourceUsageByQueueAndPool() []*PoolQueueResource {
	if m != nil {
...
func (m *NodeInfo) GetNonArmadaAllocatedResourcesTotal() map[string]*resource.Quantity {
	if m != nil {
		return m.NonArmadaAllocatedResourcesTotal
	}
	return nil
}
...
func (m *PoolQueueResource) GetResources() map[string]*resource.Quantity {
	if m != nil {
		return m.Resources
	}
	return nil
...
type JobRunLease struct {
	...
	JobRunId string                  `protobuf:"bytes,7,opt,name=job_run_id,json=jobRunId,proto3" json:"jobRunId,omitempty"`
}
...
type CancelRuns struct {
	JobRunIdsToCancel []string `protobuf:"bytes,2,rep,name=job_run_ids_to_cancel,json=jobRunIdsToCancel,proto3" json:"jobRunIdsToCancel,omitempty"`
}
...
func (m *CancelRuns) GetJobRunIdsToCancel() []string {
	if m != nil {
...
type PreemptRuns struct {
	JobRunIdsToPreempt []string `protobuf:"bytes,2,rep,name=job_run_ids_to_preempt,json=jobRunIdsToPreempt,proto3" json:"jobRunIdsToPreempt,omitempty"`
}
...
func (m *PreemptRuns) GetJobRunIdsToPreempt() []string {
	if m != nil {
...
func (*LeaseStreamMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_57e0d9d0e484e459, []int{9}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]*resource.Quantity)(nil), "executorapi.NodeInfo.NonArmadaAllocatedResourcesTotalEntry")
	...
	proto.RegisterType((*PoolQueueResource)(nil), "executorapi.PoolQueueResource")
	proto.RegisterMapType((map[string]*resource.Quantity)(nil), "executorapi.PoolQueueResource.ResourcesEntry")
...
var fileDescriptor_57e0d9d0e484e459 = []byte{
	...
	,
}
...
func (m *NodeInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NonArmadaAllocatedResourcesTotal) > 0 {
		for k := range m.NonArmadaAllocatedResourcesTotal {
			v := m.NonArmadaAllocatedResourcesTotal[k]
			baseI := i
			if v != nil {
				{
...
func (m *LeaseRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UnassignedJobRunIds) > 0 {
		for iNdEx := len(m.UnassignedJobRunIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			copy(dAtA[i:], m.UnassignedJobRunIds[iNdEx])
			i = encodeVarintExecutorapi(dAtA, i, uint64(len(m.UnassignedJobRunIds[iNdEx])))
			i--
			dAtA[i] = 0x42
		}
	}
...
func (m *CancelRuns) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.JobRunIdsToCancel) > 0 {
		for iNdEx := len(m.JobRunIdsToCancel) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.JobRunIdsToCancel[iNdEx])
			copy(dAtA[i:], m.JobRunIdsToCancel[iNdEx])
			i = encodeVarintExecutorapi(dAtA, i, uint64(len(m.JobRunIdsToCancel[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *PreemptRuns) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.JobRunIdsToPreempt) > 0 {
		for iNdEx := len(m.JobRunIdsToPreempt) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.JobRunIdsToPreempt[iNdEx])
			copy(dAtA[i:], m.JobRunIdsToPreempt[iNdEx])
			i = encodeVarintExecutorapi(dAtA, i, uint64(len(m.JobRunIdsToPreempt[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *NodeInfo) Size() (n int) {
	...
	if len(m.NonArmadaAllocatedResourcesTotal) > 0 {
		for k, v := range m.NonArmadaAllocatedResourcesTotal {
			_ = k
			_ = v
			l = 0
			if v != nil {
...
func (m *LeaseRequest) Size() (n int) {
	...
	if len(m.UnassignedJobRunIds) > 0 {
		for _, s := range m.UnassignedJobRunIds {
			l = len(s)
			n += 1 + l + sovExecutorapi(uint64(l))
		}
	}
...
func (m *CancelRuns) Size() (n int) {
	...
	_ = l
	if len(m.JobRunIdsToCancel) > 0 {
		for _, s := range m.JobRunIdsToCancel {
			l = len(s)
			n += 1 + l + sovExecutorapi(uint64(l))
		}
	}
...
func (m *PreemptRuns) Size() (n int) {
	...
	_ = l
	if len(m.JobRunIdsToPreempt) > 0 {
		for _, s := range m.JobRunIdsToPreempt {
			l = len(s)
			n += 1 + l + sovExecutorapi(uint64(l))
		}
	}
...
func (m *NodeInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NonArmadaAllocatedResourcesTotal", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NonArmadaAllocatedResourcesTotal == nil {
				m.NonArmadaAllocatedResourcesTotal = make(map[string]*resource.Quantity)
			}
			var mapkey string
			var mapvalue *resource.Quantity
			for iNdEx < postIndex {
			...
			m.NonArmadaAllocatedResourcesTotal[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipExecutorapi(dAtA[iNdEx:])
...
func (m *CancelRuns) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.JobRunIdsToCancel = append(m.JobRunIdsToCancel, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipExecutorapi(dAtA[iNdEx:])
...
func (m *PreemptRuns) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.JobRunIdsToPreempt = append(m.JobRunIdsToPreempt, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipExecutorapi(dAtA[iNdEx:])
