...
func (*EventSequence) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{0}
}
...
func (*EventSequence_Event) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{0, 0}
}
...
type EventSequence_Event_JobErrors struct {
	JobErrors *JobErrors `protobuf:"bytes,7,opt,name=jobErrors,proto3,oneof" json:"jobErrors,omitempty"`
}
type EventSequence_Event_JobRunLeased struct {
	JobRunLeased *JobRunLeased `protobuf:"bytes,8,opt,name=jobRunLeased,proto3,oneof" json:"jobRunLeased,omitempty"`
}
type EventSequence_Event_JobRunAssigned struct {
	JobRunAssigned *JobRunAssigned `protobuf:"bytes,9,opt,name=jobRunAssigned,proto3,oneof" json:"jobRunAssigned,omitempty"`
}
type EventSequence_Event_JobRunRunning struct {
	JobRunRunning *JobRunRunning `protobuf:"bytes,10,opt,name=jobRunRunning,proto3,oneof" json:"jobRunRunning,omitempty"`
}
type EventSequence_Event_JobRunSucceeded struct {
	JobRunSucceeded *JobRunSucceeded `protobuf:"bytes,11,opt,name=jobRunSucceeded,proto3,oneof" json:"jobRunSucceeded,omitempty"`
}
type EventSequence_Event_JobRunErrors struct {
	JobRunErrors *JobRunErrors `protobuf:"bytes,12,opt,name=jobRunErrors,proto3,oneof" json:"jobRunErrors,omitempty"`
}
...
func (*Uuid) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{1}
}
...
func (*SubmitJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{2}
}
...
func (*KubernetesMainObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{3}
}
...
func (*KubernetesObject) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{4}
}
...
func (*ObjectMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{5}
}
...
func (*PodSpecWithAvoidList) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{6}
}
...
func (*ReprioritiseJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{7}
}
...
func (*ReprioritiseJobSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{8}
}
...
func (*CancelJob) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{9}
}
...
func (*CancelJobSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{10}
}
...
func (*JobSucceeded) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{11}
}
...
func (*JobRunLeased) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{12}
}
...
func (*JobRunAssigned) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{13}
}
...
func (*JobRunRunning) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{14}
}
...
func (*KubernetesResourceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{15}
}
...
func (*PodInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{16}
}
...
func (*IngressInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{17}
}
...
func (*JobRunSucceeded) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{18}
}
...
func (*JobErrors) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{19}
}
...
func (m *JobErrors) GetTerminal() bool {
	if m != nil {
		return m.Terminal
	}
	return false
...
func (*JobRunErrors) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{20}
}
...
func (m *JobRunErrors) GetTerminal() bool {
	if m != nil {
		return m.Terminal
	}
	return false
...
type Error struct {
	...
	ChildErrors []*Error `protobuf:"bytes,4,rep,name=child_errors,json=childErrors,proto3" json:"child_errors,omitempty"`
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{21}
}
...
type Error_KubernetesError struct {
	KubernetesError *KubernetesError `protobuf:"bytes,5,opt,name=kubernetesError,proto3,oneof" json:"kubernetesError,omitempty"`
}
type Error_ApplicationError struct {
	ApplicationError *ApplicationError `protobuf:"bytes,6,opt,name=applicationError,proto3,oneof" json:"applicationError,omitempty"`
}
type Error_ExecutorError struct {
	ExecutorError *ExecutorError `protobuf:"bytes,7,opt,name=executorError,proto3,oneof" json:"executorError,omitempty"`
}
type Error_JobUnschedulable struct {
	JobUnschedulable *JobUnschedulable `protobuf:"bytes,8,opt,name=jobUnschedulable,proto3,oneof" json:"jobUnschedulable,omitempty"`
}
type Error_LeaseExpired struct {
	LeaseExpired *LeaseExpired `protobuf:"bytes,9,opt,name=leaseExpired,proto3,oneof" json:"leaseExpired,omitempty"`
}
type Error_JobPreempted struct {
	JobPreempted *JobPreempted `protobuf:"bytes,10,opt,name=jobPreempted,proto3,oneof" json:"jobPreempted,omitempty"`
}
type Error_MaxRunsExceeded struct {
	MaxRunsExceeded *MaxRunsExceeded `protobuf:"bytes,11,opt,name=maxRunsExceeded,proto3,oneof" json:"maxRunsExceeded,omitempty"`
}

func (*Error_KubernetesError) isError_Reason()  {}
func (*Error_ApplicationError) isError_Reason() {}
func (*Error_ExecutorError) isError_Reason()    {}
func (*Error_JobUnschedulable) isError_Reason() {}
func (*Error_LeaseExpired) isError_Reason()     {}
func (*Error_JobPreempted) isError_Reason()     {}
...
func (m *Error) GetObjectMeta() *ObjectMeta {
	if m != nil {
		return m.ObjectMeta
	}
	return nil
...
func (m *Error) GetChildErrors() []*Error {
	if m != nil {
		return m.ChildErrors
	}
	return nil
}
...
func (m *Error) GetApplicationError() *ApplicationError {
	if x, ok := m.GetReason().(*Error_ApplicationError); ok {
...
func (m *Error) GetJobUnschedulable() *JobUnschedulable {
	if x, ok := m.GetReason().(*Error_JobUnschedulable); ok {
...
func (m *Error) GetJobPreempted() *JobPreempted {
	if x, ok := m.GetReason().(*Error_JobPreempted); ok {
...
func (*Error) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Error_ApplicationError)(nil),
		(*Error_ExecutorError)(nil),
		(*Error_JobUnschedulable)(nil),
		(*Error_LeaseExpired)(nil),
		(*Error_JobPreempted)(nil),
...
func (*KubernetesError) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{22}
}
...
type ApplicationError struct {
	...
	ContainerId *Uuid `protobuf:"bytes,1,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
...
func (*ApplicationError) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{23}
}
...
func (m *ApplicationError) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ApplicationError.Merge(m, src)
}
...
func (m *ApplicationError) GetContainerId() *Uuid {
	if m != nil {
...
func (m *ApplicationError) GetExitCode() int32 {
	if m != nil {
		return m.ExitCode
	}
	return 0
...
func (m *ApplicationError) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (*ExecutorError) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{24}
}
...
type JobUnschedulable struct {
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
}

func (m *JobUnschedulable) Reset()         { *m = JobUnschedulable{} }
func (m *JobUnschedulable) String() string { return proto.CompactTextString(m) }
func (*JobUnschedulable) ProtoMessage()    {}
func (*JobUnschedulable) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{25}
}
func (m *JobUnschedulable) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JobUnschedulable) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_JobUnschedulable.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *JobUnschedulable) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobUnschedulable.Merge(m, src)
}
func (m *JobUnschedulable) XXX_Size() int {
	return m.Size()
}
func (m *JobUnschedulable) XXX_DiscardUnknown() {
	xxx_messageInfo_JobUnschedulable.DiscardUnknown(m)
}

var xxx_messageInfo_JobUnschedulable proto.InternalMessageInfo

func (m *JobUnschedulable) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (*LeaseExpired) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{26}
}
...
func (*JobPreempted) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{27}
}
...
func (*MaxRunsExceeded) Descriptor() ([]byte, []int) {
	return fileDescriptor_28a19640b6667068, []int{28}
}
...
func init() {
	...
	proto.RegisterType((*KubernetesResourceInfo)(nil), "events.KubernetesResourceInfo")
	proto.RegisterType((*PodInfo)(nil), "events.PodInfo")
	proto.RegisterType((*IngressInfo)(nil), "events.IngressInfo")
	proto.RegisterMapType((map[int32]string)(nil), "events.IngressInfo.IngressAddressesEntry")
	proto.RegisterType((*JobRunSucceeded)(nil), "events.JobRunSucceeded")
	proto.RegisterType((*JobErrors)(nil), "events.JobErrors")
	proto.RegisterType((*JobRunErrors)(nil), "events.JobRunErrors")
	proto.RegisterType((*Error)(nil), "events.Error")
	proto.RegisterType((*KubernetesError)(nil), "events.KubernetesError")
	proto.RegisterType((*ApplicationError)(nil), "events.ApplicationError")
	proto.RegisterType((*ExecutorError)(nil), "events.ExecutorError")
	proto.RegisterType((*JobUnschedulable)(nil), "events.JobUnschedulable")
	proto.RegisterType((*LeaseExpired)(nil), "events.LeaseExpired")
	proto.RegisterType((*JobPreempted)(nil), "events.JobPreempted")
	proto.RegisterType((*MaxRunsExceeded)(nil), "events.MaxRunsExceeded")
}

func init() { proto.RegisterFile("pkg/events/events.proto", fileDescriptor_28a19640b6667068) }

var fileDescriptor_28a19640b6667068 = []byte{
	// 1676 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChildErrors) > 0 {
		for iNdEx := len(m.ChildErrors) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ChildErrors[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Error_ApplicationError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Error_ApplicationError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ApplicationError != nil {
		{
			size, err := m.ApplicationError.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Error_JobUnschedulable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Error_JobUnschedulable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *Error_JobPreempted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Error_JobPreempted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ApplicationError) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ApplicationError) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ApplicationError) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *JobUnschedulable) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JobUnschedulable) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JobUnschedulable) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Error_ApplicationError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Error_JobUnschedulable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Error_JobPreempted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ApplicationError) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JobUnschedulable) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChildErrors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ChildErrors = append(m.ChildErrors, &Error{})
			if err := m.ChildErrors[len(m.ChildErrors)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApplicationError", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Reason = &Error_ApplicationError{v}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
		...
		case 8:
			...
			m.Reason = &Error_JobUnschedulable{v}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
...
func (m *ApplicationError) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplicationError: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplicationError: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *JobUnschedulable) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
