...
type StreamingLeaseRequest struct {
	...
	MinimumJobSize      map[string]resource.Quantity `protobuf:"bytes,6,rep,name=minimum_job_size,json=minimumJobSize,proto3" json:"minimumJobSize,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Nodes               []NodeInfo                   `protobuf:"bytes,7,rep,name=nodes,proto3" json:"nodes"`
	// Ids of the jobs for which all Kubernetes resources have been created.
	// Streaming these back to the server allows it to know which jobs were created in case of a network outage.
	SubmittedJobs []string `protobuf:"bytes,9,rep,name=SubmittedJobs,proto3" json:"SubmittedJobs,omitempty"`
}
...
func (m *StreamingLeaseRequest) GetSubmittedJobs() []string {
	if m != nil {
		return m.SubmittedJobs
	}
	return nil
}
...
var fileDescriptor_d92c0c680df9617a = []byte{
	...
	,
}
...
func (m *StreamingLeaseRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.SubmittedJobs) > 0 {
		for iNdEx := len(m.SubmittedJobs) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SubmittedJobs[iNdEx])
			copy(dAtA[i:], m.SubmittedJobs[iNdEx])
			i = encodeVarintQueue(dAtA, i, uint64(len(m.SubmittedJobs[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
...
func (this *StreamingLeaseRequest) String() string {
	...
	s := strings.Join([]string{`&StreamingLeaseRequest{`,
		...
		`Nodes:` + repeatedStringForNodes + `,`,
		`Pool:` + fmt.Sprintf("%v", this.Pool) + `,`,
		`SubmittedJobs:` + fmt.Sprintf("%v", this.SubmittedJobs) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *StreamingLeaseRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SubmittedJobs", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SubmittedJobs = append(m.SubmittedJobs, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQueue(dAtA[iNdEx:])
