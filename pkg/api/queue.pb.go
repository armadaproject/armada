...
type ReturnLeaseRequest struct {
	...
	AvoidNodeLabels map[string]string `protobuf:"bytes,3,rep,name=avoid_node_labels,json=avoidNodeLabels,proto3" json:"avoidNodeLabels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *ReturnLeaseRequest) GetAvoidNodeLabels() map[string]string {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "api.ReturnLeaseRequest.AvoidNodeLabelsEntry")
}
...
var fileDescriptor_d92c0c680df9617a = []byte{
	...
	,
}
...
func (m *ReturnLeaseRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AvoidNodeLabels) > 0 {
		for k := range m.AvoidNodeLabels {
			v := m.AvoidNodeLabels[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintQueue(dAtA, i, uint64(len(v)))
...
func (m *ReturnLeaseRequest) Size() (n int) {
	...
	if len(m.AvoidNodeLabels) > 0 {
		for k, v := range m.AvoidNodeLabels {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovQueue(uint64(len(k))) + 1 + len(v) + sovQueue(uint64(len(v)))
			n += mapEntrySize + 1 + sovQueue(uint64(mapEntrySize))
...
func (this *ReturnLeaseRequest) String() string {
	...
	keysForAvoidNodeLabels := make([]string, 0, len(this.AvoidNodeLabels))
	for k, _ := range this.AvoidNodeLabels {
		keysForAvoidNodeLabels = append(keysForAvoidNodeLabels, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForAvoidNodeLabels)
	mapStringForAvoidNodeLabels := "map[string]string{"
	for _, k := range keysForAvoidNodeLabels {
		mapStringForAvoidNodeLabels += fmt.Sprintf("%v: %v,", k, this.AvoidNodeLabels[k])
	}
	mapStringForAvoidNodeLabels += "}"
	s := strings.Join([]string{`&ReturnLeaseRequest{`,
		`ClusterId:` + fmt.Sprintf("%v", this.ClusterId) + `,`,
		`JobId:` + fmt.Sprintf("%v", this.JobId) + `,`,
		`AvoidNodeLabels:` + mapStringForAvoidNodeLabels + `,`,
		`}`,
	}, "")
	return s
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.AvoidNodeLabels == nil {
				m.AvoidNodeLabels = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.AvoidNodeLabels[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQueue(dAtA[iNdEx:])
