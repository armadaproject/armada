...
type LeaseRequest struct {
	...
	AutoscalingPools    []AutoscalingPool            `protobuf:"bytes,9,rep,name=autoscaling_pools,json=autoscalingPools,proto3" json:"autoscaling_pools"`
}
...
func (m *LeaseRequest) GetAutoscalingPools() []AutoscalingPool {
	if m != nil {
		return m.AutoscalingPools
	}
	return nil
}
...
type ClusterSchedulingInfoReport struct {
	...
	MinimumJobSize   map[string]resource.Quantity `protobuf:"bytes,6,rep,name=minimum_job_size,json=minimumJobSize,proto3" json:"minimumJobSize,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	AutoscalingPools []AutoscalingPool            `protobuf:"bytes,8,rep,name=autoscaling_pools,json=autoscalingPools,proto3" json:"autoscaling_pools"`
}
...
func (m *ClusterSchedulingInfoReport) GetAutoscalingPools() []AutoscalingPool {
	if m != nil {
		return m.AutoscalingPools
	}
	return nil
...
type AutoscalingPool struct {
	...
	MaxNodeCount int32     `protobuf:"varint,2,opt,name=max_node_count,json=maxNodeCount,proto3" json:"maxNodeCount,omitempty"`
}

func (m *AutoscalingPool) Reset()      { *m = AutoscalingPool{} }
func (*AutoscalingPool) ProtoMessage() {}
func (*AutoscalingPool) Descriptor() ([]byte, []int) {
	return fileDescriptor_d92c0c680df9617a, []int{5}
}
func (m *AutoscalingPool) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AutoscalingPool) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AutoscalingPool.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AutoscalingPool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AutoscalingPool.Merge(m, src)
}
func (m *AutoscalingPool) XXX_Size() int {
	return m.Size()
}
func (m *AutoscalingPool) XXX_DiscardUnknown() {
	xxx_messageInfo_AutoscalingPool.DiscardUnknown(m)
}

var xxx_messageInfo_AutoscalingPool proto.InternalMessageInfo

func (m *AutoscalingPool) GetNodeType() *NodeType {
	if m != nil {
		return m.NodeType
	}
	return nil
...
func (m *AutoscalingPool) GetMaxNodeCount() int32 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*AutoscalingPool)(nil), "api.AutoscalingPool")
...
var fileDescriptor_d92c0c680df9617a = []byte{
	...
	,
}
...
func (m *LeaseRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AutoscalingPools) > 0 {
		for iNdEx := len(m.AutoscalingPools) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.AutoscalingPools[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *AutoscalingPool) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AutoscalingPool) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AutoscalingPool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MaxNodeCount != 0 {
		i = encodeVarintQueue(dAtA, i, uint64(m.MaxNodeCount))
		i--
		dAtA[i] = 0x10
	}
	if m.NodeType != nil {
...
func (m *LeaseRequest) Size() (n int) {
	...
	if len(m.AutoscalingPools) > 0 {
		for _, e := range m.AutoscalingPools {
			l = e.Size()
			n += 1 + l + sovQueue(uint64(l))
		}
	}
...
func (m *AutoscalingPool) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.MaxNodeCount != 0 {
		n += 1 + sovQueue(uint64(m.MaxNodeCount))
	}
	return n
}
...
func (this *LeaseRequest) String() string {
	...
	repeatedStringForAutoscalingPools := "[]AutoscalingPool{"
	for _, f := range this.AutoscalingPools {
		repeatedStringForAutoscalingPools += strings.Replace(strings.Replace(f.String(), "AutoscalingPool", "AutoscalingPool", 1), `&`, ``, 1) + ","
	}
	repeatedStringForAutoscalingPools += "}"
	...
	s := strings.Join([]string{`&LeaseRequest{`,
		...
		`AutoscalingPools:` + repeatedStringForAutoscalingPools + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *AutoscalingPool) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&AutoscalingPool{`,
		`NodeType:` + strings.Replace(this.NodeType.String(), "NodeType", "NodeType", 1) + `,`,
		`MaxNodeCount:` + fmt.Sprintf("%v", this.MaxNodeCount) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *LeaseRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AutoscalingPools", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AutoscalingPools = append(m.AutoscalingPools, AutoscalingPool{})
			if err := m.AutoscalingPools[len(m.AutoscalingPools)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *AutoscalingPool) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AutoscalingPool: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AutoscalingPool: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
