...
type StreamingLeaseRequest struct {
	...
	// Run Ids of jobs currently being run by the executor
	ActiveJobRuns []string `protobuf:"bytes,8,rep,name=ActiveJobRuns,proto3" json:"ActiveJobRuns,omitempty"`
}
...
func (m *StreamingLeaseRequest) GetActiveJobRuns() []string {
	if m != nil {
		return m.ActiveJobRuns
	}
	return nil
}
...
type NodeInfo struct {
	...
	// ids of all job runs current allocated to this node
	RunIds []armadaevents.Uuid `protobuf:"bytes,8,rep,name=run_ids,json=runIds,proto3" json:"runIds"`
}
...
func (m *NodeInfo) GetRunIds() []armadaevents.Uuid {
	if m != nil {
		return m.RunIds
	}
	return nil
...
var fileDescriptor_d92c0c680df9617a = []byte{
	...
	,
}
...
func (m *StreamingLeaseRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ActiveJobRuns) > 0 {
		for iNdEx := len(m.ActiveJobRuns) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ActiveJobRuns[iNdEx])
			copy(dAtA[i:], m.ActiveJobRuns[iNdEx])
			i = encodeVarintQueue(dAtA, i, uint64(len(m.ActiveJobRuns[iNdEx])))
			i--
			dAtA[i] = 0x42
		}
	}
...
func (m *NodeInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RunIds) > 0 {
		for iNdEx := len(m.RunIds) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RunIds[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (this *StreamingLeaseRequest) String() string {
	...
	s := strings.Join([]string{`&StreamingLeaseRequest{`,
		...
		`ActiveJobRuns:` + fmt.Sprintf("%v", this.ActiveJobRuns) + `,`,
		`}`,
	}, "")
	return s
}
func (this *NodeInfo) String() string {
	...
	repeatedStringForRunIds := "[]Uuid{"
	for _, f := range this.RunIds {
		repeatedStringForRunIds += fmt.Sprintf("%v", f) + ","
	}
	repeatedStringForRunIds += "}"
	keysForLabels := make([]string, 0, len(this.Labels))
	for k, _ := range this.Labels {
		keysForLabels = append(keysForLabels, k)
	}
	...
	s := strings.Join([]string{`&NodeInfo{`,
		...
		`RunIds:` + repeatedStringForRunIds + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *StreamingLeaseRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveJobRuns", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ActiveJobRuns = append(m.ActiveJobRuns, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQueue(dAtA[iNdEx:])
...
func (m *NodeInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			m.RunIds = append(m.RunIds, armadaevents.Uuid{})
			if err := m.RunIds[len(m.RunIds)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
