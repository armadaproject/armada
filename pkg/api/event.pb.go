...
type JobUtilisationEvent struct {
	...
	PodName                     string                       `protobuf:"bytes,10,opt,name=pod_name,json=podName,proto3" json:"podName,omitempty"`
	PodNamespace                string                       `protobuf:"bytes,11,opt,name=pod_namespace,json=podNamespace,proto3" json:"podNamespace,omitempty"`
	LifetimeCumulativeResources map[string]resource.Quantity `protobuf:"bytes,12,rep,name=LifetimeCumulativeResources,proto3" json:"LifetimeCumulativeResources" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *JobUtilisationEvent) GetLifetimeCumulativeResources() map[string]resource.Quantity {
	if m != nil {
		return m.LifetimeCumulativeResources
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]resource.Quantity)(nil), "api.JobUtilisationEvent.LifetimeCumulativeResourcesEntry")
...
var fileDescriptor_7758595c3bb8cf56 = []byte{
	...
	,
}
...
func (m *JobUtilisationEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.LifetimeCumulativeResources) > 0 {
		for k := range m.LifetimeCumulativeResources {
			v := m.LifetimeCumulativeResources[k]
			baseI := i
			{
...
func (m *JobUtilisationEvent) Size() (n int) {
	...
	if len(m.LifetimeCumulativeResources) > 0 {
		for k, v := range m.LifetimeCumulativeResources {
			_ = k
			_ = v
			l = v.Size()
			mapEntrySize := 1 + len(k) + sovEvent(uint64(len(k))) + 1 + l + sovEvent(uint64(l))
...
func (this *JobUtilisationEvent) String() string {
	...
	keysForLifetimeCumulativeResources := make([]string, 0, len(this.LifetimeCumulativeResources))
	for k, _ := range this.LifetimeCumulativeResources {
		keysForLifetimeCumulativeResources = append(keysForLifetimeCumulativeResources, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForLifetimeCumulativeResources)
	mapStringForLifetimeCumulativeResources := "map[string]resource.Quantity{"
	for _, k := range keysForLifetimeCumulativeResources {
		mapStringForLifetimeCumulativeResources += fmt.Sprintf("%v: %v,", k, this.LifetimeCumulativeResources[k])
	}
	mapStringForLifetimeCumulativeResources += "}"
	s := strings.Join([]string{`&JobUtilisationEvent{`,
		...
		`PodName:` + fmt.Sprintf("%v", this.PodName) + `,`,
		`PodNamespace:` + fmt.Sprintf("%v", this.PodNamespace) + `,`,
		`LifetimeCumulativeResources:` + mapStringForLifetimeCumulativeResources + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *JobUtilisationEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LifetimeCumulativeResources", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LifetimeCumulativeResources == nil {
				m.LifetimeCumulativeResources = make(map[string]resource.Quantity)
			}
			var mapkey string
			mapvalue := &resource.Quantity{}
			for iNdEx < postIndex {
			...
			m.LifetimeCumulativeResources[mapkey] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvent(dAtA[iNdEx:])
