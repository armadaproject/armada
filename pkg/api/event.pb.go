...
func (m *Offset) GetJobsetId() int64 {
	if m != nil {
		return m.JobsetId
	}
	return 0
...
func (m *Offsets) GetOffsets() []*Offset {
	if m != nil {
		return m.Offsets
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Offset)(nil), "api.Offset")
	proto.RegisterType((*Offsets)(nil), "api.Offsets")
}
...
var fileDescriptor_7758595c3bb8cf56 = []byte{
	...
	,
}
...
func (m *Offset) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Offset != 0 {
		i = encodeVarintEvent(dAtA, i, uint64(m.Offset))
		i--
		dAtA[i] = 0x10
	}
	if m.JobsetId != 0 {
		i = encodeVarintEvent(dAtA, i, uint64(m.JobsetId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Offset) Size() (n int) {
	...
	_ = l
	if m.JobsetId != 0 {
		n += 1 + sovEvent(uint64(m.JobsetId))
	}
	if m.Offset != 0 {
		n += 1 + sovEvent(uint64(m.Offset))
	}
	return n
}
...
func (this *Offsets) String() string {
	...
	repeatedStringForOffsets := "[]*Offset{"
	for _, f := range this.Offsets {
		repeatedStringForOffsets += strings.Replace(f.String(), "Offset", "Offset", 1) + ","
	}
