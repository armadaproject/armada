...
type JobIngressInfoEvent struct {
	...
	IngressAddresses map[int32]string       `protobuf:"bytes,9,rep,name=ingress_addresses,json=ingressAddresses,proto3" json:"ingress_addresses,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type JobFailedEvent struct {
	...
	ClusterId string                 `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	Reason    string                 `protobuf:"bytes,6,opt,name=reason,proto3" json:"reason,omitempty"`
	// Deprecated: Marked as deprecated in api/event.proto.
	ExitCodes         map[string]int32   `protobuf:"bytes,7,rep,name=exit_codes,json=exitCodes,proto3" json:"exit_codes,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
type JobUtilisationEvent struct {
	...
	PodName               string                        `protobuf:"bytes,10,opt,name=pod_name,json=podName,proto3" json:"pod_name,omitempty"`
	PodNamespace          string                        `protobuf:"bytes,11,opt,name=pod_namespace,json=podNamespace,proto3" json:"pod_namespace,omitempty"`
	TotalCumulativeUsage  map[string]*resource.Quantity `protobuf:"bytes,12,rep,name=total_cumulative_usage,json=totalCumulativeUsage,proto3" json:"total_cumulative_usage,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *EventMessage) GetSubmitted() *JobSubmittedEvent {
	if x, ok := x.GetEvents().(*EventMessage_Submitted); ok {
		return x.Submitted
	}
	return nil
}
...
func (x *EventMessage) GetQueued() *JobQueuedEvent {
	if x, ok := x.GetEvents().(*EventMessage_Queued); ok {
		return x.Queued
	}
	return nil
}
...
func (x *EventMessage) GetLeased() *JobLeasedEvent {
	if x, ok := x.GetEvents().(*EventMessage_Leased); ok {
		return x.Leased
	}
	return nil
}
...
func (x *EventMessage) GetLeaseReturned() *JobLeaseReturnedEvent {
	if x, ok := x.GetEvents().(*EventMessage_LeaseReturned); ok {
...
func (x *EventMessage) GetLeaseExpired() *JobLeaseExpiredEvent {
	if x, ok := x.GetEvents().(*EventMessage_LeaseExpired); ok {
...
func (x *EventMessage) GetPending() *JobPendingEvent {
	if x, ok := x.GetEvents().(*EventMessage_Pending); ok {
		return x.Pending
	}
	return nil
}
...
func (x *EventMessage) GetRunning() *JobRunningEvent {
	if x, ok := x.GetEvents().(*EventMessage_Running); ok {
		return x.Running
	}
	return nil
}
...
func (x *EventMessage) GetUnableToSchedule() *JobUnableToScheduleEvent {
	if x, ok := x.GetEvents().(*EventMessage_UnableToSchedule); ok {
...
func (x *EventMessage) GetFailed() *JobFailedEvent {
	if x, ok := x.GetEvents().(*EventMessage_Failed); ok {
		return x.Failed
	}
	return nil
}
...
func (x *EventMessage) GetSucceeded() *JobSucceededEvent {
	if x, ok := x.GetEvents().(*EventMessage_Succeeded); ok {
		return x.Succeeded
	}
	return nil
}
...
func (x *EventMessage) GetReprioritized() *JobReprioritizedEvent {
	if x, ok := x.GetEvents().(*EventMessage_Reprioritized); ok {
...
func (x *EventMessage) GetCancelling() *JobCancellingEvent {
	if x, ok := x.GetEvents().(*EventMessage_Cancelling); ok {
		return x.Cancelling
	}
	return nil
}
...
func (x *EventMessage) GetCancelled() *JobCancelledEvent {
	if x, ok := x.GetEvents().(*EventMessage_Cancelled); ok {
		return x.Cancelled
	}
	return nil
}

func (x *EventMessage) GetTerminated() *JobTerminatedEvent {
	if x, ok := x.GetEvents().(*EventMessage_Terminated); ok {
		return x.Terminated
	}
	return nil
}
...
func (x *EventMessage) GetUtilisation() *JobUtilisationEvent {
	if x, ok := x.GetEvents().(*EventMessage_Utilisation); ok {
...
func (x *EventMessage) GetIngressInfo() *JobIngressInfoEvent {
	if x, ok := x.GetEvents().(*EventMessage_IngressInfo); ok {
...
func (x *EventMessage) GetReprioritizing() *JobReprioritizingEvent {
	if x, ok := x.GetEvents().(*EventMessage_Reprioritizing); ok {
...
func (x *EventMessage) GetPreempted() *JobPreemptedEvent {
	if x, ok := x.GetEvents().(*EventMessage_Preempted); ok {
		return x.Preempted
	}
	return nil
}
...
func (x *EventMessage) GetPreempting() *JobPreemptingEvent {
	if x, ok := x.GetEvents().(*EventMessage_Preempting); ok {
		return x.Preempting
	}
	return nil
}
...
var file_api_event_proto_rawDesc = []byte{
	...
	0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x10, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x75, 0x62,
	0x6d, 0x69, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x10, 0x61, 0x70, 0x69, 0x2f, 0x68,
	...
	0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb0, 0x01, 0x0a,
	0x11, 0x4a, 0x6f, 0x62, 0x53, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x74, 0x65, 0x64, 0x45, 0x76, 0x65,
	...
	0x74, 0x65, 0x64, 0x12, 0x1a, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x08, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4a, 0x6f, 0x62, 0x52, 0x03, 0x6a, 0x6f, 0x62, 0x22,
	0x91, 0x01, 0x0a, 0x0e, 0x4a, 0x6f, 0x62, 0x51, 0x75, 0x65, 0x75, 0x65, 0x64, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x0a, 0x6a, 0x6f, 0x62,
	0x5f, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6a,
	0x6f, 0x62, 0x53, 0x65, 0x74, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65,
	...
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x07, 0x63, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x64, 0x22, 0xb0, 0x01, 0x0a, 0x0e, 0x4a, 0x6f, 0x62, 0x4c, 0x65, 0x61, 0x73, 0x65,
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6c, 0x75, 0x73, 0x74,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6c, 0x75,
	0x73, 0x74, 0x65, 0x72, 0x49, 0x64, 0x22, 0xb8, 0x02, 0x0a, 0x15, 0x4a, 0x6f, 0x62, 0x4c, 0x65,
	0x61, 0x73, 0x65, 0x52, 0x65, 0x74, 0x75, 0x72, 0x6e, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x73, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x6e, 0x61,
	...
	,
	...
	0x02, 0x38, 0x01, 0x22, 0xf3, 0x02, 0x0a, 0x18, 0x4a, 0x6f, 0x62, 0x55, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x54, 0x6f, 0x53, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x12, 0x15, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x0a, 0x6a, 0x6f, 0x62, 0x5f, 0x73,
	0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6a, 0x6f, 0x62,
	0x53, 0x65, 0x74, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x18, 0x03,
	...
	0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x6b, 0x75, 0x62, 0x65,
	0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0c, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x49, 0x64, 0x12, 0x1b, 0x0a,
	...
	0x64, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09,
	0x70, 0x6f, 0x64, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x64,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x6f, 0x64,
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x70, 0x6f, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x70, 0x6f, 0x64,
	0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0xd5, 0x04, 0x0a, 0x0e, 0x4a, 0x6f,
	0x62, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x0a, 0x06,
	...
	0x61, 0x73, 0x6f, 0x6e, 0x12, 0x45, 0x0a, 0x0a, 0x65, 0x78, 0x69, 0x74, 0x5f, 0x63, 0x6f, 0x64,
	0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x4a,
	0x6f, 0x62, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x45, 0x78,
	0x69, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x02, 0x18, 0x01,
	0x52, 0x09, 0x65, 0x78, 0x69, 0x74, 0x43, 0x6f, 0x64, 0x65, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x6b,
	0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01,
	...
	,
	...
	,
	...
	0x52, 0x07, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x22, 0xa2, 0x02, 0x0a, 0x11, 0x4a, 0x6f, 0x62, 0x50,
	0x72, 0x65, 0x65, 0x6d, 0x70, 0x74, 0x65, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x0a,
	...
	0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x12, 0x34, 0x0a, 0x07, 0x63, 0x72, 0x65, 0x61,
	...
	,
	...
	0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73,
	0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x6b, 0x75, 0x62, 0x65, 0x72,
	0x6e, 0x65, 0x74, 0x65, 0x73, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x6f, 0x64, 0x65, 0x5f,
	...
	0x65, 0x72, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x6f, 0x64, 0x4e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18,
	0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x23,
	0x0a, 0x0d, 0x70, 0x6f, 0x64, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x70, 0x6f, 0x64, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x22, 0x9e, 0x06, 0x0a, 0x13, 0x4a, 0x6f, 0x62, 0x55, 0x74, 0x69, 0x6c, 0x69,
	0x73, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x6a,
	...
	,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x77, 0x0a, 0x19, 0x54,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0xda, 0x01, 0x0a, 0x16, 0x4a, 0x6f, 0x62, 0x52, 0x65, 0x70, 0x72,
	0x69, 0x6f, 0x72, 0x69, 0x74, 0x69, 0x7a, 0x69, 0x6e, 0x67, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
	0x15, 0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x05, 0x6a, 0x6f, 0x62, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x0a, 0x6a, 0x6f, 0x62, 0x5f, 0x73, 0x65,
	0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6a, 0x6f, 0x62, 0x53,
	0x65, 0x74, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x75, 0x65, 0x18, 0x03, 0x20,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xca, 0x01, 0x0a, 0x11,
	...
	0x65, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x6f, 0x72,
	0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xd0, 0x02, 0x0a, 0x12, 0x4a, 0x6f, 0x62,
	...
	,
	...
	,
	...
	0x22, 0x03, 0x88, 0x02, 0x01, 0x30, 0x01, 0x12, 0x3a, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x6c, 0x74,
	...
	0x6e, 0x73, 0x65, 0x42, 0x40, 0x5a, 0x27, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x61, 0x72, 0x6d, 0x61, 0x64, 0x61, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2f,
	0x61, 0x72, 0x6d, 0x61, 0x64, 0x61, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0xaa, 0x02,
	0x14, 0x41, 0x72, 0x6d, 0x61, 0x64, 0x61, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x2e, 0x49,
	0x6f, 0x2e, 0x41, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_event_proto_goTypes = []interface{}{
	...
	(*HealthCheckResponse)(nil),      // 33: api.HealthCheckResponse
}
var file_api_event_proto_depIdxs = []int32{
	29, // 0: api.JobSubmittedEvent.created:type_name -> google.protobuf.Timestamp
	30, // 1: api.JobSubmittedEvent.job:type_name -> api.Job
	29, // 2: api.JobQueuedEvent.created:type_name -> google.protobuf.Timestamp
	29, // 3: api.JobLeasedEvent.created:type_name -> google.protobuf.Timestamp
	29, // 4: api.JobLeaseReturnedEvent.created:type_name -> google.protobuf.Timestamp
	29, // 5: api.JobLeaseExpiredEvent.created:type_name -> google.protobuf.Timestamp
	29, // 6: api.JobPendingEvent.created:type_name -> google.protobuf.Timestamp
	29, // 7: api.JobRunningEvent.created:type_name -> google.protobuf.Timestamp
	29, // 8: api.JobIngressInfoEvent.created:type_name -> google.protobuf.Timestamp
	25, // 9: api.JobIngressInfoEvent.ingress_addresses:type_name -> api.JobIngressInfoEvent.IngressAddressesEntry
	29, // 10: api.JobUnableToScheduleEvent.created:type_name -> google.protobuf.Timestamp
	29, // 11: api.JobFailedEvent.created:type_name -> google.protobuf.Timestamp
	...
	29, // 15: api.JobPreemptingEvent.created:type_name -> google.protobuf.Timestamp
	29, // 16: api.JobPreemptedEvent.created:type_name -> google.protobuf.Timestamp
	29, // 17: api.JobSucceededEvent.created:type_name -> google.protobuf.Timestamp
	29, // 18: api.JobUtilisationEvent.created:type_name -> google.protobuf.Timestamp
	...
	29, // 21: api.JobReprioritizingEvent.created:type_name -> google.protobuf.Timestamp
	29, // 22: api.JobReprioritizedEvent.created:type_name -> google.protobuf.Timestamp
	29, // 23: api.JobCancellingEvent.created:type_name -> google.protobuf.Timestamp
	29, // 24: api.JobCancelledEvent.created:type_name -> google.protobuf.Timestamp
	29, // 25: api.JobTerminatedEvent.created:type_name -> google.protobuf.Timestamp
	1,  // 26: api.EventMessage.submitted:type_name -> api.JobSubmittedEvent
	2,  // 27: api.EventMessage.queued:type_name -> api.JobQueuedEvent
	3,  // 28: api.EventMessage.leased:type_name -> api.JobLeasedEvent
	4,  // 29: api.EventMessage.lease_returned:type_name -> api.JobLeaseReturnedEvent
	5,  // 30: api.EventMessage.lease_expired:type_name -> api.JobLeaseExpiredEvent
	6,  // 31: api.EventMessage.pending:type_name -> api.JobPendingEvent
	7,  // 32: api.EventMessage.running:type_name -> api.JobRunningEvent
	9,  // 33: api.EventMessage.unable_to_schedule:type_name -> api.JobUnableToScheduleEvent
	10, // 34: api.EventMessage.failed:type_name -> api.JobFailedEvent
	13, // 35: api.EventMessage.succeeded:type_name -> api.JobSucceededEvent
	16, // 36: api.EventMessage.reprioritized:type_name -> api.JobReprioritizedEvent
	17, // 37: api.EventMessage.cancelling:type_name -> api.JobCancellingEvent
	18, // 38: api.EventMessage.cancelled:type_name -> api.JobCancelledEvent
	19, // 39: api.EventMessage.terminated:type_name -> api.JobTerminatedEvent
	...
	31, // 47: api.JobUtilisationEvent.MaxResourcesForPeriodEntry.value:type_name -> k8s.io.apimachinery.pkg.api.resource.Quantity
	31, // 48: api.JobUtilisationEvent.TotalCumulativeUsageEntry.value:type_name -> k8s.io.apimachinery.pkg.api.resource.Quantity
	23, // 49: api.Event.GetJobSetEvents:input_type -> api.JobSetRequest
	24, // 50: api.Event.Watch:input_type -> api.WatchRequest
	32, // 51: api.Event.Health:input_type -> google.protobuf.Empty
	22, // 52: api.Event.GetJobSetEvents:output_type -> api.EventStreamMessage
	22, // 53: api.Event.Watch:output_type -> api.EventStreamMessage
	33, // 54: api.Event.Health:output_type -> api.HealthCheckResponse
...
func file_api_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobSubmittedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobLeaseReturnedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobLeaseExpiredEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobIngressInfoEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobUnableToScheduleEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobPreemptingEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobPreemptedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobSucceededEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobUtilisationEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobReprioritizingEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobReprioritizedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JobTerminatedEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_event_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EventStreamMessage); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_api_event_proto_msgTypes[19].OneofWrappers = []interface{}{
