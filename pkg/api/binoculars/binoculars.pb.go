...
type LogRequest struct {
	...
	RunIndex int32 `protobuf:"varint,6,opt,name=run_index,json=runIndex,proto3" json:"runIndex,omitempty"`
	// If true, include run_index in pod name lookup. False for legacy pods without run index suffix.
	IncludeRunIndex bool `protobuf:"varint,7,opt,name=include_run_index,json=includeRunIndex,proto3" json:"includeRunIndex,omitempty"`
}
...
func (m *LogRequest) GetRunIndex() int32 {
	if m != nil {
		return m.RunIndex
	}
	return 0
...
func (m *LogRequest) GetIncludeRunIndex() bool {
	if m != nil {
		return m.IncludeRunIndex
	}
	return false
}
...
var fileDescriptor_3f2fc8093f6f091f = []byte{
	...
	,
}
...
func (m *LogRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.RunIndex != 0 {
		i = encodeVarintBinoculars(dAtA, i, uint64(m.RunIndex))
		i--
		dAtA[i] = 0x30
	}
	if m.LogOptions != nil {
...
func (m *LogRequest) Size() (n int) {
	...
	if m.RunIndex != 0 {
		n += 1 + sovBinoculars(uint64(m.RunIndex))
	}
	if m.IncludeRunIndex {
		n += 2
	}
...
func (m *LogRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncludeRunIndex", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
