...
func SwaggerJsonTemplate() string {
	var tmpl = "{\n" +
		...
		"          \"type\": \"array\",\n" +
		"          \"items\": {\n" +
		"            \"$ref\": \"#/definitions/v1ContainerRestartRule\"\n" +
		"          },\n" +
		...
		"      \"properties\": {\n" +
		"        \"action\": {\n" +
		"          \"$ref\": \"#/definitions/v1ContainerRestartRuleAction\"\n" +
		"        },\n" +
		"        \"exitCodes\": {\n" +
		"          \"$ref\": \"#/definitions/v1ContainerRestartRuleOnExitCodes\"\n" +
		"        }\n" +
		"      },\n" +
		"      \"x-go-package\": \"k8s.io/api/core/v1\"\n" +
		"    },\n" +
		...
		"      \"properties\": {\n" +
		"        \"operator\": {\n" +
		"          \"$ref\": \"#/definitions/v1ContainerRestartRuleOnExitCodesOperator\"\n" +
		"        },\n" +
		"        \"values\": {\n" +
		...
		"        },\n" +
		"        \"fileKeyRef\": {\n" +
		"          \"$ref\": \"#/definitions/v1FileKeySelector\"\n" +
		"        },\n" +
		"        \"resourceFieldRef\": {\n" +
		"          \"$ref\": \"#/definitions/v1ResourceFieldSelector\"\n" +
		"        },\n" +
		...
		"      \"description\": \"The scheduler uses this information to apply workload-aware scheduling semantics.\\nExactly one field must be specified.\\n+union\",\n" +
		"      \"type\": \"object\",\n" +
		"      \"title\": \"PodSchedulingGroup identifies the runtime scheduling group instance that a Pod belongs to.\",\n" +
		"      \"properties\": {\n" +
		"        \"podGroupName\": {\n" +
		...
		"        },\n" +
		"        \"schedulingGroup\": {\n" +
		"          \"$ref\": \"#/definitions/v1PodSchedulingGroup\"\n" +
		"        },\n" +
		"        \"securityContext\": {\n" +
		...
		"        \"trafficDistribution\": {\n" +
		"          \"type\": \"string\",\n" +
		"          \"title\": \"TrafficDistribution offers a way to express preferences for how traffic\\nis distributed to Service endpoints. Implementations can use this field\\nas a hint, but are not required to guarantee strict adherence. If the\\nfield is not set, the implementation will apply its default routing\\nstrategy. If set to \\\"PreferClose\\\", implementations should prioritize\\nendpoints that are in the same zone.\\n+optional\"\n" +
		"        },\n" +
		"        \"type\": {\n" +
		"          \"type\": \"string\",\n" +
		...
		"        },\n" +
		"        \"podCertificate\": {\n" +
		"          \"$ref\": \"#/definitions/v1PodCertificateProjection\"\n" +
		"        },\n" +
		"        \"secret\": {\n" +
