...
const (
	...
	IngressType_Headless IngressType = 2
)
...
func (m *IngressConfig) GetSelector() map[string]string {
	if m != nil {
		return m.Selector
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "api.IngressConfig.SelectorEntry")
...
var fileDescriptor_e998bacb27df16c1 = []byte{
	...
	,
}
