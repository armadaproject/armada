...
// It's value indicates if the message is a control message or a utilization message.
//
// We need this because, we currently submit legacy utilization messages directly to the log
// (i.e., not as part of an EventSequence).
//
// Hence, consumers can distinguish between control and utilization messages by inspecting this property.
