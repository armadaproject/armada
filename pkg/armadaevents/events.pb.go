...
// These messages represent the reason for why the por/container failed.
// We use empty messages to give the option of adding fields specific to each cause later.
type OutOfMemory struct {
}

func (m *OutOfMemory) Reset()         { *m = OutOfMemory{} }
func (m *OutOfMemory) String() string { return proto.CompactTextString(m) }
func (*OutOfMemory) ProtoMessage()    {}
func (*OutOfMemory) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{27}
}
func (m *OutOfMemory) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OutOfMemory) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OutOfMemory.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *OutOfMemory) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OutOfMemory.Merge(m, src)
}
func (m *OutOfMemory) XXX_Size() int {
	return m.Size()
}
func (m *OutOfMemory) XXX_DiscardUnknown() {
	xxx_messageInfo_OutOfMemory.DiscardUnknown(m)
}

var xxx_messageInfo_OutOfMemory proto.InternalMessageInfo

type Evicted struct {
}

func (m *Evicted) Reset()         { *m = Evicted{} }
func (m *Evicted) String() string { return proto.CompactTextString(m) }
func (*Evicted) ProtoMessage()    {}
func (*Evicted) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{28}
}
func (m *Evicted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Evicted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Evicted.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Evicted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Evicted.Merge(m, src)
}
func (m *Evicted) XXX_Size() int {
	return m.Size()
}
func (m *Evicted) XXX_DiscardUnknown() {
	xxx_messageInfo_Evicted.DiscardUnknown(m)
}

var xxx_messageInfo_Evicted proto.InternalMessageInfo
...
func (m *DeadlineExceeded) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DeadlineExceeded.Merge(m, src)
}
...
type PodError struct {
	...
	//	*PodError_OutOfMemory
	//	*PodError_Error
	//	*PodError_Evicted
	//	*PodError_DeadlineExceeded
	KubernetesReason isPodError_KubernetesReason `protobuf_oneof:"KubernetesReason"`
}
...
type isPodError_KubernetesReason interface {
	isPodError_KubernetesReason()
	MarshalTo([]byte) (int, error)
	Size() int
}

type PodError_OutOfMemory struct {
	OutOfMemory *OutOfMemory `protobuf:"bytes,6,opt,name=outOfMemory,proto3,oneof" json:"outOfMemory,omitempty"`
}
type PodError_Error struct {
	Error *Error `protobuf:"bytes,7,opt,name=error,proto3,oneof" json:"error,omitempty"`
}
type PodError_Evicted struct {
	Evicted *Evicted `protobuf:"bytes,8,opt,name=evicted,proto3,oneof" json:"evicted,omitempty"`
}
type PodError_DeadlineExceeded struct {
	DeadlineExceeded *DeadlineExceeded `protobuf:"bytes,9,opt,name=deadlineExceeded,proto3,oneof" json:"deadlineExceeded,omitempty"`
}

func (*PodError_OutOfMemory) isPodError_KubernetesReason()      {}
func (*PodError_Error) isPodError_KubernetesReason()            {}
func (*PodError_Evicted) isPodError_KubernetesReason()          {}
func (*PodError_DeadlineExceeded) isPodError_KubernetesReason() {}

func (m *PodError) GetKubernetesReason() isPodError_KubernetesReason {
	if m != nil {
...
func (m *PodError) GetOutOfMemory() *OutOfMemory {
	if x, ok := m.GetKubernetesReason().(*PodError_OutOfMemory); ok {
		return x.OutOfMemory
	}
	return nil
}

func (m *PodError) GetError() *Error {
	if x, ok := m.GetKubernetesReason().(*PodError_Error); ok {
		return x.Error
	}
	return nil
}

func (m *PodError) GetEvicted() *Evicted {
	if x, ok := m.GetKubernetesReason().(*PodError_Evicted); ok {
		return x.Evicted
	}
	return nil
}

func (m *PodError) GetDeadlineExceeded() *DeadlineExceeded {
	if x, ok := m.GetKubernetesReason().(*PodError_DeadlineExceeded); ok {
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*PodError) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*PodError_OutOfMemory)(nil),
		(*PodError_Error)(nil),
		(*PodError_Evicted)(nil),
		(*PodError_DeadlineExceeded)(nil),
	}
}
...
type ContainerError struct {
	...
	//
	// Types that are valid to be assigned to KubernetesReason:
	//	*ContainerError_OutOfMemory
	//	*ContainerError_Error
	//	*ContainerError_Evicted
	//	*ContainerError_DeadlineExceeded
...
type ContainerError_OutOfMemory struct {
	OutOfMemory *OutOfMemory `protobuf:"bytes,5,opt,name=outOfMemory,proto3,oneof" json:"outOfMemory,omitempty"`
}
...
type ContainerError_Evicted struct {
	Evicted *Evicted `protobuf:"bytes,7,opt,name=evicted,proto3,oneof" json:"evicted,omitempty"`
}
type ContainerError_DeadlineExceeded struct {
	DeadlineExceeded *DeadlineExceeded `protobuf:"bytes,8,opt,name=deadlineExceeded,proto3,oneof" json:"deadlineExceeded,omitempty"`
}

func (*ContainerError_OutOfMemory) isContainerError_KubernetesReason()      {}
func (*ContainerError_Error) isContainerError_KubernetesReason()            {}
func (*ContainerError_Evicted) isContainerError_KubernetesReason()          {}
func (*ContainerError_DeadlineExceeded) isContainerError_KubernetesReason() {}
...
func (m *ContainerError) GetOutOfMemory() *OutOfMemory {
	if x, ok := m.GetKubernetesReason().(*ContainerError_OutOfMemory); ok {
		return x.OutOfMemory
	}
	return nil
}
...
func (m *ContainerError) GetEvicted() *Evicted {
	if x, ok := m.GetKubernetesReason().(*ContainerError_Evicted); ok {
		return x.Evicted
	}
	return nil
}

func (m *ContainerError) GetDeadlineExceeded() *DeadlineExceeded {
	if x, ok := m.GetKubernetesReason().(*ContainerError_DeadlineExceeded); ok {
		return x.DeadlineExceeded
	}
	return nil
}
...
func (*ContainerError) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ContainerError_OutOfMemory)(nil),
		(*ContainerError_Error)(nil),
		(*ContainerError_Evicted)(nil),
		(*ContainerError_DeadlineExceeded)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*OutOfMemory)(nil), "armadaevents.OutOfMemory")
	proto.RegisterType((*Evicted)(nil), "armadaevents.Evicted")
	proto.RegisterType((*DeadlineExceeded)(nil), "armadaevents.DeadlineExceeded")
...
var fileDescriptor_6aab92ca59e015f8 = []byte{
	...
	,
}
...
func (m *OutOfMemory) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *OutOfMemory) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OutOfMemory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Evicted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Evicted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Evicted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *DeadlineExceeded) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PodError_OutOfMemory) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PodError_OutOfMemory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *PodError_Error) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PodError_Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Error != nil {
		{
...
func (m *PodError_Evicted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PodError_Evicted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Evicted != nil {
		{
...
func (m *PodError_DeadlineExceeded) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PodError_DeadlineExceeded) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *PodError_OutOfMemory) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PodError_Error) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PodError_Evicted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PodError_DeadlineExceeded) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OutOfMemory) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Evicted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *PodError) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.KubernetesReason = &PodError_OutOfMemory{v}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
			...
			m.KubernetesReason = &PodError_Error{v}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
			...
			m.KubernetesReason = &PodError_Evicted{v}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
			...
			m.KubernetesReason = &PodError_DeadlineExceeded{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
...
func (m *ContainerError) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.KubernetesReason = &ContainerError_OutOfMemory{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Error", wireType)
		...
		case 7:
			...
			m.KubernetesReason = &ContainerError_Evicted{v}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeadlineExceeded", wireType)
			...
			m.KubernetesReason = &ContainerError_DeadlineExceeded{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
