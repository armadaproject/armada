...
type JobRunLeased struct {
	...
	// Because zero is a valid priority, we need to be able to distinguish the
	// case where `scheduled_at_priority` was explicitly set to zero from the
	// case where it was not set at all; moreover, we would like to make this
	// field required (at the application level) further down the line.
	//
	// Using `Int32Value` instead of `int32` is not an option, because
	// moving from one of these types to the other is a wire-incompatible
	// change.
	//
	// Recent versions of proto3 have the `optional` keyword, which would
	// address all of our issues, but github.com/gogo/protobuf does not support
	// it yet (and likely never will, because this project has been abandoned).
	//
	// We could wrap `scheduled_at_priority` in `oneof`, but the generated code
	// is hideous.
	//
	// Instead, we just have a boolean field to accompany `scheduled_at_priority`;
	// we can drop it once `scheduled_at_priority` is set everywhere.
...
var fileDescriptor_6aab92ca59e015f8 = []byte{
	...
	,
}
