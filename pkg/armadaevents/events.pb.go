...
type EventSequence_Event struct {
	...
	//	*EventSequence_Event_JobRunTerminatedDebugInfo
	//	*EventSequence_Event_JobRunTerminated
	//	*EventSequence_Event_JobRunStarted
...
type EventSequence_Event_JobRunTerminatedDebugInfo struct {
	JobRunTerminatedDebugInfo *JobRunTerminatedDebugInfo `protobuf:"bytes,26,opt,name=jobRunTerminatedDebugInfo,proto3,oneof" json:"jobRunTerminatedDebugInfo,omitempty"`
}
type EventSequence_Event_JobRunTerminated struct {
	JobRunTerminated *JobRunTerminated `protobuf:"bytes,27,opt,name=jobRunTerminated,proto3,oneof" json:"jobRunTerminated,omitempty"`
}
type EventSequence_Event_JobRunStarted struct {
	JobRunStarted *JobRunStarted `protobuf:"bytes,28,opt,name=jobRunStarted,proto3,oneof" json:"jobRunStarted,omitempty"`
}
...
func (*EventSequence_Event_JobRunTerminatedDebugInfo) isEventSequence_Event_Event() {}
func (*EventSequence_Event_JobRunTerminated) isEventSequence_Event_Event()          {}
func (*EventSequence_Event_JobRunStarted) isEventSequence_Event_Event()             {}
...
func (m *EventSequence_Event) GetJobRunTerminatedDebugInfo() *JobRunTerminatedDebugInfo {
	if x, ok := m.GetEvent().(*EventSequence_Event_JobRunTerminatedDebugInfo); ok {
		return x.JobRunTerminatedDebugInfo
	}
	return nil
}

func (m *EventSequence_Event) GetJobRunTerminated() *JobRunTerminated {
	if x, ok := m.GetEvent().(*EventSequence_Event_JobRunTerminated); ok {
		return x.JobRunTerminated
	}
	return nil
}

func (m *EventSequence_Event) GetJobRunStarted() *JobRunStarted {
	if x, ok := m.GetEvent().(*EventSequence_Event_JobRunStarted); ok {
		return x.JobRunStarted
	}
	return nil
}
...
func (*EventSequence_Event) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*EventSequence_Event_JobRunTerminatedDebugInfo)(nil),
		(*EventSequence_Event_JobRunTerminated)(nil),
		(*EventSequence_Event_JobRunStarted)(nil),
	}
}
...
type SubmitJob struct {
	...
	// If not set, falls back to the "armadaproject.io/externalJobUri" annotation.
	ExternalJobUri string `protobuf:"bytes,16,opt,name=external_job_uri,json=externalJobUri,proto3" json:"externalJobUri,omitempty"`
}
...
func (m *SubmitJob) GetExternalJobUri() string {
	if m != nil {
...
func (m *ReprioritisedJob) GetRequestor() string {
	if m != nil {
		return m.Requestor
	}
	return ""
...
func (m *CancelJob) GetRequestor() string {
	if m != nil {
		return m.Requestor
	}
	return ""
...
func (m *CancelledJob) GetRequestor() string {
	if m != nil {
		return m.Requestor
	}
	return ""
...
func (m *JobRunAssigned) GetPool() string {
	if m != nil {
		return m.Pool
	}
	return ""
...
type JobRunRunning struct {
	...
	RunId         string                    `protobuf:"bytes,5,opt,name=run_id,json=runId,proto3" json:"runId,omitempty"`
	Pool          string                    `protobuf:"bytes,6,opt,name=pool,proto3" json:"pool,omitempty"`
	StartedAt     *types.Timestamp          `protobuf:"bytes,7,opt,name=started_at,json=startedAt,proto3" json:"startedAt,omitempty"`
}
...
func (m *JobRunRunning) GetPool() string {
	if m != nil {
		return m.Pool
	}
	return ""
...
func (m *JobRunRunning) GetStartedAt() *types.Timestamp {
	if m != nil {
		return m.StartedAt
	}
	return nil
...
// Records an application start timestamp discovered after the run has already
// transitioned to running. Unlike JobRunRunning, this does not change state.
type JobRunStarted struct {
	...
	StartedAt *types.Timestamp `protobuf:"bytes,3,opt,name=started_at,json=startedAt,proto3" json:"startedAt,omitempty"`
}
...
func (*JobRunStarted) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{19}
}
func (m *JobRunStarted) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JobRunStarted) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_JobRunStarted.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *JobRunStarted) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobRunStarted.Merge(m, src)
}
func (m *JobRunStarted) XXX_Size() int {
	return m.Size()
}
func (m *JobRunStarted) XXX_DiscardUnknown() {
	xxx_messageInfo_JobRunStarted.DiscardUnknown(m)
}

var xxx_messageInfo_JobRunStarted proto.InternalMessageInfo

func (m *JobRunStarted) GetJobId() string {
	if m != nil {
		return m.JobId
	}
	return ""
...
func (m *JobRunStarted) GetRunId() string {
	if m != nil {
		return m.RunId
	}
	return ""
...
func (m *JobRunStarted) GetStartedAt() *types.Timestamp {
	if m != nil {
		return m.StartedAt
	}
	return nil
...
type JobRunSucceeded struct {
	...
	JobId         string                    `protobuf:"bytes,4,opt,name=job_id,json=jobId,proto3" json:"jobId,omitempty"`
	RunId         string                    `protobuf:"bytes,5,opt,name=run_id,json=runId,proto3" json:"runId,omitempty"`
	FinishedAt    *types.Timestamp          `protobuf:"bytes,6,opt,name=finished_at,json=finishedAt,proto3" json:"finishedAt,omitempty"`
}
...
func (m *JobRunSucceeded) GetFinishedAt() *types.Timestamp {
	if m != nil {
		return m.FinishedAt
	}
	return nil
...
func (m *JobRunErrors) GetFinishedAt() *types.Timestamp {
	if m != nil {
		return m.FinishedAt
	}
	return nil
...
type Error struct {
	...
	// Mutually exclusive failure category from the first matching executor classifier rule.
	// Suitable as a metric dimension that sums to 100%.
	...
	// Optional tag from the matching classifier rule for drill-down.
	...
	// Name of the retry policy that decided this run's retry or terminal
	// failure. Empty when no retry policy applied.
	RetryPolicyName string `protobuf:"bytes,18,opt,name=retry_policy_name,json=retryPolicyName,proto3" json:"retryPolicyName,omitempty"`
}
...
func (m *Error) GetFailureCategory() string {
	if m != nil {
...
func (m *Error) GetFailureSubcategory() string {
	if m != nil {
...
func (m *Error) GetRetryPolicyName() string {
	if m != nil {
		return m.RetryPolicyName
	}
	return ""
}
...
type JobRunPreempted struct {
	...
	PreemptingJobId string `protobuf:"bytes,8,opt,name=preempting_job_id,json=preemptingJobId,proto3" json:"preemptingJobId,omitempty"`
	Requestor       string `protobuf:"bytes,9,opt,name=requestor,proto3" json:"requestor,omitempty"`
}
...
func (m *JobRunPreempted) GetPreemptingJobId() string {
	if m != nil {
...
func (m *JobRunPreempted) GetRequestor() string {
	if m != nil {
		return m.Requestor
	}
	return ""
...
func (m *JobRunCancelled) GetReason() string {
	if m != nil {
		return m.Reason
	}
	return ""
...
func (m *JobRunCancelled) GetRequestor() string {
	if m != nil {
		return m.Requestor
	}
	return ""
...
type JobRunTerminated struct {
	JobId      string           `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"jobId,omitempty"`
	RunId      string           `protobuf:"bytes,2,opt,name=run_id,json=runId,proto3" json:"runId,omitempty"`
	FinishedAt *types.Timestamp `protobuf:"bytes,3,opt,name=finished_at,json=finishedAt,proto3" json:"finishedAt,omitempty"`
}

func (m *JobRunTerminated) Reset()         { *m = JobRunTerminated{} }
func (m *JobRunTerminated) String() string { return proto.CompactTextString(m) }
func (*JobRunTerminated) ProtoMessage()    {}
func (*JobRunTerminated) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{47}
}
func (m *JobRunTerminated) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JobRunTerminated) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_JobRunTerminated.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *JobRunTerminated) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobRunTerminated.Merge(m, src)
}
func (m *JobRunTerminated) XXX_Size() int {
	return m.Size()
}
func (m *JobRunTerminated) XXX_DiscardUnknown() {
	xxx_messageInfo_JobRunTerminated.DiscardUnknown(m)
}

var xxx_messageInfo_JobRunTerminated proto.InternalMessageInfo

func (m *JobRunTerminated) GetJobId() string {
	if m != nil {
		return m.JobId
	}
	return ""
...
func (m *JobRunTerminated) GetRunId() string {
	if m != nil {
		return m.RunId
	}
	return ""
...
func (m *JobRunTerminated) GetFinishedAt() *types.Timestamp {
	if m != nil {
		return m.FinishedAt
	}
	return nil
...
// Emitted by the executor when a job run is torn down without the workload having run to
// completion - cancelled before its main container ever started, or stuck terminating. debugMessage
// is a JSON document describing the pod, its node and their recent Kubernetes events, carrying a
// schemaVersion and the trigger that produced it, so the reason is not lost.
// This is purely diagnostic: it does NOT represent an error and does NOT change the run's state.
// Only Lookout consumes it, to populate the run's debug column; all other consumers ignore it.
type JobRunTerminatedDebugInfo struct {
	JobId        string `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"jobId,omitempty"`
	RunId        string `protobuf:"bytes,2,opt,name=run_id,json=runId,proto3" json:"runId,omitempty"`
	DebugMessage string `protobuf:"bytes,3,opt,name=debugMessage,proto3" json:"debugMessage,omitempty"`
}

func (m *JobRunTerminatedDebugInfo) Reset()         { *m = JobRunTerminatedDebugInfo{} }
func (m *JobRunTerminatedDebugInfo) String() string { return proto.CompactTextString(m) }
func (*JobRunTerminatedDebugInfo) ProtoMessage()    {}
func (*JobRunTerminatedDebugInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{48}
}
func (m *JobRunTerminatedDebugInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JobRunTerminatedDebugInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_JobRunTerminatedDebugInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *JobRunTerminatedDebugInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobRunTerminatedDebugInfo.Merge(m, src)
}
func (m *JobRunTerminatedDebugInfo) XXX_Size() int {
	return m.Size()
}
func (m *JobRunTerminatedDebugInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_JobRunTerminatedDebugInfo.DiscardUnknown(m)
}

var xxx_messageInfo_JobRunTerminatedDebugInfo proto.InternalMessageInfo

func (m *JobRunTerminatedDebugInfo) GetJobId() string {
	if m != nil {
		return m.JobId
	}
	return ""
...
func (m *JobRunTerminatedDebugInfo) GetRunId() string {
	if m != nil {
		return m.RunId
	}
	return ""
...
func (m *JobRunTerminatedDebugInfo) GetDebugMessage() string {
	if m != nil {
		return m.DebugMessage
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*JobRunStarted)(nil), "armadaevents.JobRunStarted")
	...
	proto.RegisterType((*JobRunTerminated)(nil), "armadaevents.JobRunTerminated")
	proto.RegisterType((*JobRunTerminatedDebugInfo)(nil), "armadaevents.JobRunTerminatedDebugInfo")
}
...
var fileDescriptor_6aab92ca59e015f8 = []byte{
	...
	,
}
...
func (m *EventSequence_Event_JobRunTerminatedDebugInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventSequence_Event_JobRunTerminatedDebugInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.JobRunTerminatedDebugInfo != nil {
		{
			size, err := m.JobRunTerminatedDebugInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *EventSequence_Event_JobRunTerminated) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventSequence_Event_JobRunTerminated) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.JobRunTerminated != nil {
		{
			size, err := m.JobRunTerminated.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *EventSequence_Event_JobRunStarted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventSequence_Event_JobRunStarted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.JobRunStarted != nil {
		{
			size, err := m.JobRunStarted.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SubmitJob) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ExternalJobUri) > 0 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(len(m.ExternalJobUri)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
...
func (m *CancelJobSet) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.States) > 0 {
		dAtA46 := make([]byte, len(m.States)*10)
		var j45 int
		for _, num := range m.States {
			for num >= 1<<7 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(j45))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *JobRunStarted) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JobRunStarted) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JobRunStarted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RetryPolicyName) > 0 {
		i -= len(m.RetryPolicyName)
		copy(dAtA[i:], m.RetryPolicyName)
		i = encodeVarintEvents(dAtA, i, uint64(len(m.RetryPolicyName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	if len(m.FailureSubcategory) > 0 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(len(m.FailureSubcategory)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
	...
	if len(m.FailureCategory) > 0 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(len(m.FailureCategory)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x82
...
func (m *JobRunPreempted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PreemptingJobId) > 0 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(len(m.PreemptingJobId)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Reason) > 0 {
...
func (m *JobRunTerminated) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JobRunTerminated) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JobRunTerminated) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *JobRunTerminatedDebugInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JobRunTerminatedDebugInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JobRunTerminatedDebugInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventSequence_Event_JobRunTerminatedDebugInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.JobRunTerminatedDebugInfo != nil {
		l = m.JobRunTerminatedDebugInfo.Size()
		n += 2 + l + sovEvents(uint64(l))
	}
	return n
}
func (m *EventSequence_Event_JobRunTerminated) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.JobRunTerminated != nil {
		l = m.JobRunTerminated.Size()
		n += 2 + l + sovEvents(uint64(l))
	}
	return n
}
func (m *EventSequence_Event_JobRunStarted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JobRunStarted) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JobRunTerminated) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JobRunTerminatedDebugInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventSequence_Event) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JobRunTerminatedDebugInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &JobRunTerminatedDebugInfo{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Event = &EventSequence_Event_JobRunTerminatedDebugInfo{v}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JobRunTerminated", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Event = &EventSequence_Event_JobRunTerminated{v}
			iNdEx = postIndex
		case 28:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JobRunStarted", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Event = &EventSequence_Event_JobRunStarted{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
...
func (m *JobRunStarted) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobRunStarted: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobRunStarted: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RetryPolicyName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RetryPolicyName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
...
func (m *JobRunTerminated) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobRunTerminated: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobRunTerminated: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *JobRunTerminatedDebugInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobRunTerminatedDebugInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobRunTerminatedDebugInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
