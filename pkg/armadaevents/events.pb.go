...
type JobRunPreempted struct {
	...
	PreemptiveJobId string `protobuf:"bytes,8,opt,name=preemptive_job_id,json=preemptiveJobId,proto3" json:"preemptiveJobId,omitempty"`
}
...
func (m *JobRunPreempted) GetPreemptiveJobId() string {
	if m != nil {
...
var fileDescriptor_6aab92ca59e015f8 = []byte{
	...
	0x45, 0x19, 0x23, 0x98, 0x28, 0x3b, 0xc1, 0x87, 0xe1, 0x16, 0x9c, 0x0e, 0x66, 0xe4, 0xf6, 0x71,
	...
	0x00, 0x00, 0x00, 0xff, 0xff, 0xd1, 0x6a, 0x53, 0x7f, 0x81, 0x3d, 0x00, 0x00,
}
