...
type EventSequence_Event struct {
	...
	//	*EventSequence_Event_JobSubmitChecked
...
type EventSequence_Event_JobSubmitChecked struct {
	JobSubmitChecked *JobSubmitChecked `protobuf:"bytes,25,opt,name=jobSubmitChecked,proto3,oneof" json:"jobSubmitChecked,omitempty"`
}
...
func (*EventSequence_Event_JobSubmitChecked) isEventSequence_Event_Event()          {}
...
func (m *EventSequence_Event) GetJobSubmitChecked() *JobSubmitChecked {
	if x, ok := m.GetEvent().(*EventSequence_Event_JobSubmitChecked); ok {
		return x.JobSubmitChecked
	}
	return nil
}
...
func (*EventSequence_Event) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*EventSequence_Event_JobSubmitChecked)(nil),
	}
}
...
// Indicates that the scheduler has confirmed that the job can be run on at least one node
type JobSubmitChecked struct {
	JobId *Uuid `protobuf:"bytes,1,opt,name=job_id,json=jobId,proto3" json:"jobId,omitempty"`
}

func (m *JobSubmitChecked) Reset()         { *m = JobSubmitChecked{} }
func (m *JobSubmitChecked) String() string { return proto.CompactTextString(m) }
func (*JobSubmitChecked) ProtoMessage()    {}
func (*JobSubmitChecked) Descriptor() ([]byte, []int) {
	return fileDescriptor_6aab92ca59e015f8, []int{45}
}
func (m *JobSubmitChecked) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JobSubmitChecked) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_JobSubmitChecked.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *JobSubmitChecked) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JobSubmitChecked.Merge(m, src)
}
func (m *JobSubmitChecked) XXX_Size() int {
	return m.Size()
}
func (m *JobSubmitChecked) XXX_DiscardUnknown() {
	xxx_messageInfo_JobSubmitChecked.DiscardUnknown(m)
}

var xxx_messageInfo_JobSubmitChecked proto.InternalMessageInfo

func (m *JobSubmitChecked) GetJobId() *Uuid {
	if m != nil {
		return m.JobId
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*JobSubmitChecked)(nil), "armadaevents.JobSubmitChecked")
...
var fileDescriptor_6aab92ca59e015f8 = []byte{
	...
	,
}
...
func (m *EventSequence_Event_JobSubmitChecked) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventSequence_Event_JobSubmitChecked) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.JobSubmitChecked != nil {
		{
			size, err := m.JobSubmitChecked.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *JobSubmitChecked) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JobSubmitChecked) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JobSubmitChecked) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventSequence_Event_JobSubmitChecked) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JobSubmitChecked) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventSequence_Event) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JobSubmitChecked", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Event = &EventSequence_Event_JobSubmitChecked{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipEvents(dAtA[iNdEx:])
...
func (m *JobSubmitChecked) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JobSubmitChecked: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JobSubmitChecked: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
