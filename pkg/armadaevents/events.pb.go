...
// Condition that caused a job failure, derived from Kubernetes signals.
...
const (
	...
	FailureCondition_FAILURE_CONDITION_USER_ERROR        FailureCondition = 5
)
...
var FailureCondition_name = map[int32]string{
	...
	5: "FAILURE_CONDITION_USER_ERROR",
}
...
var FailureCondition_value = map[string]int32{
	...
	"FAILURE_CONDITION_USER_ERROR":        5,
}
...
type Error struct {
	...
	// Structured failure metadata (exit code, condition, categories).
	// Set by the executor for pod failures; nil for non-pod errors.
...
// Structured failure metadata extracted from pod status at the executor.
// Attached to Error messages to enable category-based retry policies and
// observability in Lookout.
type FailureInfo struct {
	// Exit code of the first failed container (0 if no container terminated with failure).
	ExitCode int32 `protobuf:"varint,1,opt,name=exit_code,json=exitCode,proto3" json:"exitCode,omitempty"`
	// Failure condition derived from Kubernetes pod status signals.
	...
	// Result from the executor's pod checks system (podchecks.Checks).
	...
	// Executor-assigned category labels, matched from ErrorCategories config.
	Categories []string `protobuf:"bytes,6,rep,name=categories,proto3" json:"categories,omitempty"`
	// Name of the container that exit_code and termination_message were extracted from.
	ContainerName string `protobuf:"bytes,7,opt,name=container_name,json=containerName,proto3" json:"containerName,omitempty"`
}
...
func (m *FailureInfo) GetCategories() []string {
	if m != nil {
		return m.Categories
	}
	return nil
...
func (m *FailureInfo) GetContainerName() string {
	if m != nil {
...
var fileDescriptor_6aab92ca59e015f8 = []byte{
	...
	,
}
...
func (m *FailureInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ContainerName) > 0 {
		...
		i = encodeVarintEvents(dAtA, i, uint64(len(m.ContainerName)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.Categories) > 0 {
		for iNdEx := len(m.Categories) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintEvents(dAtA, i, uint64(len(m.Categories[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
