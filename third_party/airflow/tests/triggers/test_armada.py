            ...
            },
            {
                ...
                "expected_responses": [
                    TriggerEvent({
                        "status": "error",
                        "job_id": DEFAULT_JOB_ID,
                        "response": f"Job {DEFAULT_JOB_ID} did not succeed. Final status was FAILED",
                    })
                ]
            },
            {
                ...
                "expected_responses": [
                    TriggerEvent({
                        "status": "error",
                        "job_id": DEFAULT_JOB_ID,
                        "response": f"Job {DEFAULT_JOB_ID} did not succeed. Final status was CANCELLED",
                    })
                ]
            },
            {
                ...
                "expected_responses": [
                    TriggerEvent({
                        "status": "error",
                        "job_id": DEFAULT_JOB_ID,
                        "response": f"Job {DEFAULT_JOB_ID} not acknowledged within timeout {DEFAULT_JOB_ACKNOWLEDGEMENT_TIMEOUT}.",
                    })
                ]
            },
            {
                ...
                "expected_responses": [
                    TriggerEvent({
                        "status": "error",
                        "job_id": DEFAULT_JOB_ID,
                        "response": f"Job {DEFAULT_JOB_ID} did not succeed. Final status was PREEMPTED",
                    })
                ]
            },
            {
