...
class KubernetesPodLogManager(LoggingMixin):
    ...
    def _parse_log_line(self, line: bytes) -> Tuple[DateTime | None, str]:
        ...
        """
        # We need to parse datetime for every single log-line returned from the K8S job
        # so we know it's beginning of new log-line, rather multi-line log line.
        # This is a short-circuit to test that line looks like it's starting with a date.
