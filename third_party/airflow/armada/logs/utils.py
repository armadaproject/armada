...
if TYPE_CHECKING:
    from kubernetes.client.models.v1_container_status import (  # noqa: F811
        V1ContainerStatus,
    )
...
def get_container_status(pod: V1Pod, container_name: str) -> V1ContainerStatus | None:
    ...
    if container_statuses:
        # In general the variable container_statuses can store multiple items matching
        # different containers.
        # The following generator expression yields all items that have name equal to
        # the container_name.
        # The function next() here calls the generator to get only the first value. If
