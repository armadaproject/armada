...
RELEASE_INFO_REPLY=$(curl --fail -H "Authorization: token $API_TOKEN" https://api.github.com/repos/ljubon/armada/releases/tags/$RELEASE_TAG)
...
curl -H "Authorization: token $API_TOKEN" -X PATCH https://api.github.com/repos/ljubon/armada/releases/$RELEASE_ID --data "$JSON_STRING"
