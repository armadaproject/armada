...
cp pkg/api/event.proto pkg/api/queue.proto pkg/api/submit.proto pkg/api/usage.proto pkg/api/health.proto pkg/queryapi/queryapi.proto proto/armada
...
python3 -m grpc_tools.protoc -I. --plugin=protoc-gen-mypy=$(which protoc-gen-mypy) --python_out=../client/python/armada_client --grpc_python_out=../client/python/armada_client --mypy_out=../client/python/armada_client \
    ...
    armada/event.proto armada/queue.proto armada/submit.proto armada/usage.proto armada/health.proto armada/queryapi.proto \
