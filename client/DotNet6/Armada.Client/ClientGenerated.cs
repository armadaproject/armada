...
namespace GResearch.Armada.Client
{
    ...
    public partial class ArmadaClient 
    {
        ...
        public virtual System.Threading.Tasks.Task<ApiBatchQueueCreateResponse> CreateQueuesAsync(ApiQueueList body)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiBatchQueueCreateResponse> CreateQueuesAsync(ApiQueueList body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiBatchQueueCreateResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ApiBatchQueueUpdateResponse> UpdateQueuesAsync(ApiQueueList body)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiBatchQueueUpdateResponse> UpdateQueuesAsync(ApiQueueList body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiBatchQueueUpdateResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        protected virtual System.Threading.Tasks.Task<FileResponse> GetJobSetEventsCoreAsync(string queue, string id, ApiJobSetRequest body)
        {
        ...
        /// <returns>A successful response.(streaming responses)</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        protected virtual async System.Threading.Tasks.Task<FileResponse> GetJobSetEventsCoreAsync(string queue, string id, ApiJobSetRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (queue == null)
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ApiCancellationResult> CancelJobsAsync(ApiJobCancelRequest body)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiCancellationResult> CancelJobsAsync(ApiJobCancelRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiCancellationResult>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ApiJobReprioritizeResponse> ReprioritizeJobsAsync(ApiJobReprioritizeRequest body)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiJobReprioritizeResponse> ReprioritizeJobsAsync(ApiJobReprioritizeRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiJobReprioritizeResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ApiJobSubmitResponse> SubmitJobsAsync(ApiJobSubmitRequest body)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiJobSubmitResponse> SubmitJobsAsync(ApiJobSubmitRequest body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiJobSubmitResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<object> CreateQueueAsync(ApiQueue body)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> CreateQueueAsync(ApiQueue body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ApiQueue> GetQueueAsync(string name)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiQueue> GetQueueAsync(string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiQueue>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<object> UpdateQueueAsync(string name, ApiQueue body)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> UpdateQueueAsync(string name, ApiQueue body, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<object> DeleteQueueAsync(string name)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> DeleteQueueAsync(string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ApiQueueInfo> GetQueueInfoAsync(string name)
        {
        ...
        /// <returns>A successful response.</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ApiQueueInfo> GetQueueInfoAsync(string name, System.Threading.CancellationToken cancellationToken)
        {
            if (name == null)
                throw new System.ArgumentNullException("name");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ApiQueueInfo>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    public partial class ApiJob
    {
        ...
        /// <br/>These options are exclusive, i.e., if either ingress or services is provided,
        /// <br/>then neither of k8s_ingress or k8s_service can be provided, and vice versa.
        /// </summary>
        ...
        /// <br/>github.com.G-Research.armada.internal.events.
        /// </summary>
    ...
    /// <summary>
    /// +protobuf=true
    /// <br/>+protobuf.options.(gogoproto.goproto_stringer)=false
    /// <br/>+k8s:openapi-gen=true
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>must also be in the same AWS zone as the kubelet. An AWS EBS disk
    /// <br/>can only be mounted as read/write once. AWS EBS volumes support
    /// <br/>ownership management and SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1AWSElasticBlockStoreVolumeSource
    {
        ...
        /// <br/>Tip: Ensure that the filesystem type is supported by the host operating system.
        /// <br/>Examples: "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore
        ...
        /// <br/>If omitted, the default is to mount by volume name.
        /// <br/>Examples: For volume /dev/sda1, you specify the partition as "1".
        /// <br/>Similarly, the volume partition for /dev/sda is "0" (or you can leave the property empty).
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>If omitted, the default is "false".
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#awselasticblockstore
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1AzureDiskVolumeSource
    {
        ...
        /// <br/>Must be a filesystem type supported by the host operating system.
        /// <br/>Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string FsType { get; set; }
        ...
        /// <br/>the ReadOnly setting in VolumeMounts.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("readOnly", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? ReadOnly { get; set; }
    ...
    public partial class V1CSIVolumeSource
    {
        ...
        /// <br/>Consult with your admin for the correct name as registered in the cluster.
        /// </summary>
        ...
        /// <br/>If not provided, the empty value is passed to the associated CSI driver
        /// <br/>which will determine the default filesystem to apply.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string FsType { get; set; }
        ...
        /// <br/>Defaults to false (read/write).
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("readOnly", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? ReadOnly { get; set; }
        ...
        /// <br/>driver. Consult your driver's documentation for supported values.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>Cephfs volumes do not support ownership management or SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1CephFSVolumeSource
    {
        ...
        /// <br/>More info: https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it
        /// </summary>
    ...
    /// <br/>The volume must also be in the same region as the kubelet.
    /// <br/>Cinder volumes support ownership management and SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1CinderVolumeSource
    {
        ...
        /// <br/>Must be a filesystem type supported by the host operating system.
        /// <br/>Examples: "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
        /// <br/>More info: https://examples.k8s.io/mysql-cinder-pd/README.md
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string FsType { get; set; }
    ...
    /// <br/>key-value pairs as environment variables.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1ConfigMapEnvSource
    {
        ...
        /// <br/>More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names
        /// <br/>TODO: Add other useful fields. apiVersion, kind, uid?
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
    ...
    /// <br/>projected volume as files using the keys in the Data field as the file names,
    /// <br/>unless the items element is populated with specific mappings of keys to paths.
    /// <br/>Note that this is identical to a configmap volume source without the default
    /// <br/>mode.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1ConfigMapProjection
    {
        ...
        /// <br/>ConfigMap will be projected into the volume as a file whose name is the
        /// <br/>key and content is the value. If specified, the listed keys will be
        /// <br/>projected into the specified paths, and unlisted keys will not be
        /// <br/>present. If a key is specified which is not present in the ConfigMap,
        /// <br/>the volume setup will error unless it is marked optional. Paths must be
        /// <br/>relative and may not contain the '..' path or start with '..'.
        /// <br/>+optional
        /// </summary>
    ...
    /// <summary>
    /// The contents of the target ConfigMap's Data field will be presented in a
    /// <br/>volume as files using the keys in the Data field as the file names, unless
    /// <br/>the items element is populated with specific mappings of keys to paths.
    /// <br/>ConfigMap volumes support ownership management and SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1ConfigMapVolumeSource
    {
        ...
        /// <br/>Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511.
        /// <br/>YAML accepts both octal and decimal values, JSON requires decimal values for mode bits.
        /// <br/>Defaults to 0644.
        /// <br/>Directories within the path are not affected by this setting.
        /// <br/>This might be in conflict with other options that affect the file
        /// <br/>mode, like fsGroup, and the result can be other mode bits set.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1Container
    {
        ...
        /// <br/>The docker image's CMD is used if this is not provided.
        /// <br/>Variable references $(VAR_NAME) are expanded using the container's environment. If a variable
        /// <br/>cannot be resolved, the reference in the input string will be unchanged. Double $$ are reduced
        /// <br/>to a single $, which allows for escaping the $(VAR_NAME) syntax: i.e. "$$(VAR_NAME)" will
        /// <br/>produce the string literal "$(VAR_NAME)". Escaped references will never be expanded, regardless
        /// <br/>of whether the variable exists or not. Cannot be updated.
        /// <br/>More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>The docker image's ENTRYPOINT is used if this is not provided.
        /// <br/>Variable references $(VAR_NAME) are expanded using the container's environment. If a variable
        /// <br/>cannot be resolved, the reference in the input string will be unchanged. Double $$ are reduced
        /// <br/>to a single $, which allows for escaping the $(VAR_NAME) syntax: i.e. "$$(VAR_NAME)" will
        /// <br/>produce the string literal "$(VAR_NAME)". Escaped references will never be expanded, regardless
        ...
        /// <br/>Cannot be updated.
        /// <br/>+optional
        /// <br/>+patchMergeKey=name
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>The keys defined within a source must be a C_IDENTIFIER. All invalid keys
        /// <br/>will be reported as an event when the container is starting. When a key exists in multiple
        /// <br/>sources, the value associated with the last source will take precedence.
        /// <br/>Values defined by an Env with a duplicate key will take precedence.
        /// <br/>Cannot be updated.
        /// <br/>+optional
        /// </summary>
        ...
        /// <summary>
        /// Docker image name.
        /// <br/>More info: https://kubernetes.io/docs/concepts/containers/images
        /// <br/>This field is optional to allow higher level config management to default or override
        /// <br/>container images in workload controllers like Deployments and StatefulSets.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Each container in a pod must have a unique name (DNS_LABEL).
        /// <br/>Cannot be updated.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
        ...
        /// <br/>the system additional information about the network connections a
        /// <br/>container uses, but is primarily informational. Not specifying a port here
        /// <br/>DOES NOT prevent that port from being exposed. Any port which is
        /// <br/>listening on the default "0.0.0.0" address inside a container will be
        /// <br/>accessible from the network.
        /// <br/>Cannot be updated.
        /// <br/>+optional
        /// <br/>+patchMergeKey=containerPort
        /// <br/>+patchStrategy=merge
        /// <br/>+listType=map
        /// <br/>+listMapKey=containerPort
        /// <br/>+listMapKey=protocol
        /// </summary>
        [Newtonsoft.Json.JsonProperty("ports", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <br/>is not set, reads from stdin in the container will always result in EOF.
        /// <br/>Default is false.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>a single attach. When stdin is true the stdin stream will remain open across multiple attach
        /// <br/>sessions. If stdinOnce is set to true, stdin is opened on container start, is empty until the
        /// <br/>first client attaches to stdin, and then remains open and accepts data until the client disconnects,
        /// <br/>at which time stdin is closed and remains closed until the container is restarted. If this
        /// <br/>flag is false, a container processes that reads from stdin will never receive an EOF.
        /// <br/>Default is false
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>will be written is mounted into the container's filesystem.
        /// <br/>Message written is intended to be brief final status, such as an assertion failure message.
        /// <br/>Will be truncated by the node if greater than 4096 bytes. The total message length across
        /// <br/>all containers will be limited to 12kb.
        /// <br/>Defaults to /dev/termination-log.
        /// <br/>Cannot be updated.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>If not specified, the container runtime's default will be used, which
        /// <br/>might be configured in the container image.
        /// <br/>Cannot be updated.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1ContainerPort
    {
        ...
        /// <br/>This must be a valid port number, 0 &lt; x &lt; 65536.
        /// </summary>
        ...
        /// <br/>If specified, this must be a valid port number, 0 &lt; x &lt; 65536.
        /// <br/>If HostNetwork is specified, this must match ContainerPort.
        /// <br/>Most containers do not need this.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>named port in a pod must have a unique name. Name for the port that can be
        /// <br/>referred to by services.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
    ...
    public partial class V1DownwardAPIVolumeFile
    {
        ...
        /// <br/>between 0000 and 0777 or a decimal value between 0 and 511.
        /// <br/>YAML accepts both octal and decimal values, JSON requires decimal values for mode bits.
        /// <br/>If not specified, the volume defaultMode will be used.
        /// <br/>This might be in conflict with other options that affect the file
        /// <br/>mode, like fsGroup, and the result can be other mode bits set.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1DownwardAPIVolumeSource
    {
        ...
        /// <br/>Optional: mode bits used to set permissions on created files by default.
        /// <br/>Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511.
        /// <br/>YAML accepts both octal and decimal values, JSON requires decimal values for mode bits.
        /// <br/>Defaults to 0644.
        /// <br/>Directories within the path are not affected by this setting.
    ...
    public partial class V1EnvVar
    {
        ...
        /// <br/>using the previously defined environment variables in the container and
        /// <br/>any service environment variables. If a variable cannot be resolved,
        /// <br/>the reference in the input string will be unchanged. Double $$ are reduced
        /// <br/>to a single $, which allows for escaping the $(VAR_NAME) syntax: i.e.
        /// <br/>"$$(VAR_NAME)" will produce the string literal "$(VAR_NAME)".
        /// <br/>Escaped references will never be expanded, regardless of whether the variable
        /// <br/>exists or not.
        /// <br/>Defaults to "".
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>user-initiated activities such as debugging. Ephemeral containers have no resource or
    /// <br/>scheduling guarantees, and they will not be restarted when they exit or when a pod is
    /// <br/>removed or restarted. If an ephemeral container causes a pod to exceed its resource
    /// <br/>allocation, the pod may be evicted.
    /// <br/>Ephemeral containers may not be added by directly updating the pod spec. They must be added
    /// <br/>via the pod's ephemeralcontainers subresource, and they will appear in the pod spec
    /// <br/>once added.
    /// <br/>This is an alpha feature enabled by the EphemeralContainers feature flag.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1EphemeralContainer
    {
        ...
        /// <br/>This name must be unique among all containers, init containers and ephemeral containers.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
        ...
        /// <br/>The ephemeral container will be run in the namespaces (IPC, PID, etc) of this container.
        /// <br/>If not set then the ephemeral container is run in whatever namespaces are shared
        /// <br/>for the pod. Note that the container runtime must support this feature.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1ExecAction
    {
        ...
        /// <br/>command  is root ('/') in the container's filesystem. The command is simply exec'd, it is
        /// <br/>not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use
        /// <br/>a shell, you need to explicitly call out to that shell.
        /// <br/>Exit status of 0 is treated as live/healthy and non-zero is unhealthy.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("command", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> Command { get; set; }
    ...
    /// <br/>Fibre Channel volumes support ownership management and SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1FCVolumeSource
    {
        ...
        /// <br/>Either wwids or combination of targetWWNs and lun must be set, but not both simultaneously.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>or a string representing a sub-field or item. The string will follow one of these four formats:
    /// <br/>'f:&lt;name&gt;', where &lt;name&gt; is the name of a field in a struct, or key in a map
    /// <br/>'v:&lt;value&gt;', where &lt;value&gt; is the exact json formatted value of a list item
    /// <br/>'i:&lt;index&gt;', where &lt;index&gt; is position of a item in a list
    /// <br/>'k:&lt;keys&gt;', where &lt;keys&gt; is a map of  a list item's key fields to their unique values
    /// <br/>If a key maps to an empty Fields value, the field that key represents is part of the set.
    /// <br/>
    ...
    /// <br/>provisioned/attached using an exec based plugin.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1FlexVolumeSource
    {
        ...
        /// Filesystem type to mount.
        /// <br/>Must be a filesystem type supported by the host operating system.
        /// <br/>Ex. "ext4", "xfs", "ntfs". The default filesystem depends on FlexVolume script.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string FsType { get; set; }
    ...
    /// <br/>Flocker volumes do not support ownership management or SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1FlockerVolumeSource
    {
        ...
        /// <br/>should be considered as deprecated
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>also be in the same GCE project and zone as the kubelet. A GCE PD
    /// <br/>can only be mounted as read/write once or read-only many times. GCE
    /// <br/>PDs support ownership management and SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1GCEPersistentDiskVolumeSource
    {
        ...
        /// <br/>Tip: Ensure that the filesystem type is supported by the host operating system.
        /// <br/>Examples: "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk
        /// <br/>TODO: how do we prevent errors in the filesystem from compromising the machine
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <br/>EmptyDir into an InitContainer that clones the repo using git, then mount the EmptyDir
    /// <br/>into the Pod's container.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1GitRepoVolumeSource
    {
        ...
        /// <br/>Must not contain or start with '..'.  If '.' is supplied, the volume directory will be the
        /// <br/>git repository.  Otherwise, if specified, the volume will contain the git repository in
        /// <br/>the subdirectory with the given name.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1GlusterfsVolumeSource
    {
        ...
        /// <br/>More info: https://examples.k8s.io/volumes/glusterfs/README.md#create-a-pod
        /// </summary>
    ...
    public partial class V1HTTPGetAction
    {
        ...
        /// <br/>"Host" in httpHeaders instead.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>path are forwarded to the backend.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1HTTPIngressPath
    {
        ...
        /// <br/>be one of the following values:
        /// <br/>* Exact: Matches the URL path exactly.
        /// <br/>* Prefix: Matches based on a URL path prefix split by '/'. Matching is
    ...
    /// <br/>In the example: http://&lt;host&gt;/&lt;path&gt;?&lt;searchpart&gt; -&gt; backend where
    /// <br/>where parts of the url correspond to RFC 3986, this resource will be used
    /// <br/>to match against everything after the last '/' and before the first '?'
    /// <br/>or '#'.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>TODO: pass structured data to these actions, and document that data here.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class V1HostPathVolumeSource
    {
        ...
        /// <br/>If the path is a symlink, it will follow the link to the real path.
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#hostpath
        /// </summary>
        [Newtonsoft.Json.JsonProperty("path", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Path { get; set; }
    ...
    /// <br/>ISCSI volumes support ownership management and SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1ISCSIVolumeSource
    {
        ...
        /// <br/>Tip: Ensure that the filesystem type is supported by the host operating system.
        /// <br/>Examples: "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#iscsi
        /// <br/>TODO: how do we prevent errors in the filesystem from compromising the machine
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <br/>If initiatorName is specified with iscsiInterface simultaneously, new iSCSI interface
        /// <br/>&lt;target portal&gt;:&lt;volume name&gt; will be created for the connection.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>is other than default (typically TCP ports 860 and 3260).
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>endpoints defined by a backend. An Ingress can be configured to give services
    /// <br/>externally-reachable urls, load balance traffic, terminate SSL, offer name
    /// <br/>based virtual hosting etc.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>the related backend services. Incoming requests are first evaluated for a host
    /// <br/>match, then routed to the backend associated with the matching IngressRuleValue.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1IngressRule
    {
        ...
        /// <br/>Note the following deviations from the "host" part of the
        /// <br/>URI as defined in RFC 3986:
        /// <br/>1. IPs are not allowed. Currently an IngressRuleValue can only apply to
        ...
        /// <br/>	  :443 for https.
        /// <br/>Both these may change in the future.
        /// <br/>Incoming requests are matched against the host before the
        /// <br/>IngressRuleValue. If the host is unspecified, the Ingress routes all
        /// <br/>traffic based on the specified IngressRuleValue.
        /// <br/>
        /// <br/>Host can be "precise" which is a domain name without the terminating dot of
        /// <br/>a network host (e.g. "foo.bar.com") or "wildcard", which is a domain name
        /// <br/>prefixed with a single wildcard label (e.g. "*.foo.com").
        /// <br/>The wildcard character '*' must appear by itself as the first DNS label and
        /// <br/>matches only a single label. You cannot have a wildcard label by itself (e.g. Host == "*").
        /// <br/>Requests will be matched against the Host field in the following way:
        /// <br/>1. If Host is precise, the request matches this rule if the http host header is equal to Host.
        /// <br/>2. If Host is a wildcard, then the request matches this rule if the http host header
        /// <br/>is to equal to the suffix (removing the first label) of the wildcard rule.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("host", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Host { get; set; }
    ...
    /// <br/>rule is satisfied, the request is routed to the specified backend. Currently
    /// <br/>mixing different types of rules in a single Ingress is disallowed, so exactly
    /// <br/>one of the following must be set.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class V1IngressServiceBackend
    {
        ...
        /// <br/>the same namespace as the Ingress object.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
        ...
        /// <br/>is required for a IngressServiceBackend.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("port", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class V1KeyToPath
    {
        ...
        /// <br/>May not be an absolute path.
        /// <br/>May not contain the path element '..'.
        /// <br/>May not start with the string '..'.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("path", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Path { get; set; }
    ...
    /// <br/>matchExpressions are ANDed. An empty label selector matches all objects. A null
    /// <br/>label selector matches no objects.
    /// <br/>+structType=atomic
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1LabelSelector
    {
        ...
        /// <br/>map is equivalent to an element of matchExpressions, whose key field is "key", the
        /// <br/>operator is "In", and the values array contains only "value". The requirements are ANDed.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1LabelSelectorRequirement
    {
        ...
        /// <br/>the values array must be non-empty. If the operator is Exists or DoesNotExist,
        /// <br/>the values array must be empty. This array is replaced during a strategic
        /// <br/>merge patch.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>events. For the PostStart and PreStop lifecycle handlers, management of the container blocks
    /// <br/>until the action is complete, unless the container process fails, in which case the handler is aborted.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>traffic intended for the service should be sent to an ingress point.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>referenced object inside the same namespace.
    /// <br/>+structType=atomic
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>that the fieldset applies to.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1ManagedFieldsEntry
    {
        ...
        /// <br/>applies to. The format is "group/version" just like the top-level
        /// <br/>APIVersion field. It is necessary to track the version of a field
        /// <br/>set because it cannot be automatically converted.
        /// </summary>
        ...
        /// <br/>There is currently only one possible value: "FieldsV1"
        /// </summary>
        ...
        /// <br/>empty string if the object was updated through the main resource. The
        /// <br/>value of this field is used to distinguish between managers, even if they
        /// <br/>share the same name. For example, a status update will be distinct from a
        /// <br/>regular update using the same manager name.
        /// <br/>Note that the APIVersion field is not related to the Subresource field and
        /// <br/>it always corresponds to the version of the main resource.
        /// </summary>
    ...
    public partial class V1NFSVolumeSource
    {
        ...
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs
        /// </summary>
        [Newtonsoft.Json.JsonProperty("path", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Path { get; set; }
        ...
        /// <br/>the NFS export to be mounted with read-only permissions.
        /// <br/>Defaults to false.
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1NodeAffinity
    {
        ...
        /// <br/>the affinity expressions specified by this field, but it may choose
        /// <br/>a node that violates one or more of the expressions. The node that is
        /// <br/>most preferred is the one with the greatest sum of weights, i.e.
        /// <br/>for each node that meets all of the scheduling requirements (resource
        /// <br/>request, requiredDuringScheduling affinity expressions, etc.),
        /// <br/>compute a sum by iterating through the elements of this field and adding
        /// <br/>"weight" to the sum if the node matches the corresponding matchExpressions; the
        /// <br/>node(s) with the highest sum are the most preferred.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>over a set of nodes; that is, it represents the OR of the selectors represented
    /// <br/>by the node selector terms.
    /// <br/>+structType=atomic
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>that relates the key and values.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1NodeSelectorRequirement
    {
        ...
        /// <br/>the values array must be non-empty. If the operator is Exists or DoesNotExist,
        /// <br/>the values array must be empty. If the operator is Gt or Lt, the values
        /// <br/>array must have a single element, which will be interpreted as an integer.
        /// <br/>This array is replaced during a strategic merge patch.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("values", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> Values { get; set; }
    ...
    /// <br/>them are ANDed.
    /// <br/>The TopologySelectorTerm type implements a subset of the NodeSelectorTerm.
    /// <br/>+structType=atomic
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    public partial class V1ObjectMeta
    {
        ...
        /// <br/>set by external tools to store and retrieve arbitrary metadata. They are not
        /// <br/>queryable and should be preserved when modifying objects.
        /// <br/>More info: http://kubernetes.io/docs/user-guide/annotations
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("annotations", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IDictionary<string, string> Annotations { get; set; }
        ...
        /// <br/>This is used to distinguish resources with same name and namespace in different clusters.
        /// <br/>This field is not set anywhere right now and apiserver is going to ignore it if set in create or update request.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>it will be removed from the system. Only set when deletionTimestamp is also set.
        /// <br/>May only be shortened.
        /// <br/>Read-only.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>is an identifier for the responsible component that will remove the entry
        /// <br/>from the list. If the deletionTimestamp of the object is non-nil, entries
        /// <br/>in this list can only be removed.
        /// <br/>Finalizers may be processed and removed in any order.  Order is NOT enforced
        /// <br/>because it introduces significant risk of stuck finalizers.
        /// <br/>finalizers is a shared field, any actor with permission can reorder it.
        /// <br/>If the finalizer list is processed in order, then this can lead to a situation
        /// <br/>in which the component responsible for the first finalizer in the list is
        /// <br/>waiting for a signal (field value, external system, or other) produced by a
        /// <br/>component responsible for a finalizer later in the list, resulting in a deadlock.
        /// <br/>Without enforced ordering finalizers are free to order amongst themselves and
        /// <br/>are not vulnerable to ordering changes in the list.
        /// <br/>+optional
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>name ONLY IF the Name field has not been provided.
        /// <br/>If this field is used, the name returned to the client will be different
        /// <br/>than the name passed. This value will also be combined with a unique suffix.
        /// <br/>The provided value has the same validation rules as the Name field,
        /// <br/>and may be truncated by the length of the suffix required to make the value
        /// <br/>unique on the server.
        /// <br/>
        /// <br/>If this field is specified and the generated name exists, the server will
        /// <br/>NOT return a 409 - instead, it will either return 201 Created or 500 with Reason
        /// <br/>ServerTimeout indicating a unique name could not be found in the time allotted, and the client
        /// <br/>should retry (optionally after the time indicated in the Retry-After header).
        /// <br/>
        /// <br/>Applied only if Name is not specified.
        /// <br/>More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#idempotency
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Populated by the system. Read-only.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>(scope and select) objects. May match selectors of replication controllers
        /// <br/>and services.
        /// <br/>More info: http://kubernetes.io/docs/user-guide/labels
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("labels", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.IDictionary<string, string> Labels { get; set; }
        ...
        /// <br/>that are managed by that workflow. This is mostly for internal
        /// <br/>housekeeping, and users typically shouldn't need to set or
        /// <br/>understand this field. A workflow can be the user's name, a
        /// <br/>controller's name, or the name of a specific apply path like
        /// <br/>"ci-cd". The set of fields is always in the version that the
        /// <br/>workflow used when modifying the object.
        /// <br/>
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>some resources may allow a client to request the generation of an appropriate name
        /// <br/>automatically. Name is primarily intended for creation idempotence and configuration
        /// <br/>definition.
        /// <br/>Cannot be updated.
        /// <br/>More info: http://kubernetes.io/docs/user-guide/identifiers#names
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
        ...
        /// <br/>equivalent to the "default" namespace, but "default" is the canonical representation.
        /// <br/>Not all objects are required to be scoped to a namespace - the value of this field for
        /// <br/>those objects will be empty.
        /// <br/>
        /// <br/>Must be a DNS_LABEL.
        /// <br/>Cannot be updated.
        /// <br/>More info: http://kubernetes.io/docs/user-guide/namespaces
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("namespace", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Namespace { get; set; }
        ...
        /// <br/>been deleted, this object will be garbage collected. If this object is managed by a controller,
        /// <br/>then an entry in this list will point to this controller, with the controller field set to true.
        /// <br/>There cannot be more than one managing controller.
        /// <br/>+optional
        /// <br/>+patchMergeKey=uid
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>be used by clients to determine when objects have changed. May be used for optimistic
        /// <br/>concurrency, change detection, and the watch operation on a resource or set of resources.
        /// <br/>Clients must treat these values as opaque and passed unmodified back to the server.
        /// <br/>They may only be valid for a particular resource or set of resources.
        /// <br/>
        /// <br/>Populated by the system.
        /// <br/>Read-only.
        /// <br/>Value must be treated as opaque by clients and .
        /// <br/>More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>
        /// <br/>DEPRECATED
        /// <br/>Kubernetes will stop propagating this field in 1.20 release and the field is planned
        /// <br/>to be removed in 1.21 release.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>object. An owning object must be in the same namespace as the dependent, or
    /// <br/>be cluster-scoped, so there is no namespace field.
    /// <br/>+structType=atomic
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1OwnerReference
    {
        ...
        /// <br/>the owner cannot be deleted from the key-value store until this
        /// <br/>reference is removed.
        /// <br/>Defaults to false.
        /// <br/>To set this field, a user needs "delete" permission of the owner,
        /// <br/>otherwise 422 (Unprocessable Entity) will be returned.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
        /// </summary>
        [Newtonsoft.Json.JsonProperty("kind", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Kind { get; set; }
    ...
    /// <br/>and allows a Source for provider-specific attributes
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1PersistentVolumeClaimSpec
    {
        ...
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#class-1
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>PersistentVolumeClaim objects as part of an EphemeralVolumeSource.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>PersistentVolumeClaimVolumeSource is, essentially, a wrapper around another
    /// <br/>type of volume that is owned by someone else (the system).
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1PersistentVolumeClaimVolumeSource
    {
        ...
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims
        /// </summary>
    ...
    public partial class V1PodAffinity
    {
        ...
        /// <br/>request, requiredDuringScheduling affinity expressions, etc.),
        /// <br/>compute a sum by iterating through the elements of this field and adding
        /// <br/>"weight" to the sum if the node has pods which matches the corresponding podAffinityTerm; the
        /// <br/>node(s) with the highest sum are the most preferred.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("preferredDuringSchedulingIgnoredDuringExecution", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <br/>scheduling time, the pod will not be scheduled onto the node.
        /// <br/>If the affinity requirements specified by this field cease to be met
        /// <br/>at some point during pod execution (e.g. due to a pod label update), the
        /// <br/>system may or may not try to eventually evict the pod from its node.
        /// <br/>When there are multiple elements, the lists of nodes corresponding to each
        /// <br/>podAffinityTerm are intersected, i.e. all terms must be satisfied.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("requiredDuringSchedulingIgnoredDuringExecution", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <br/>relative to the given namespace(s)) that this pod should be
    /// <br/>co-located (affinity) or not co-located (anti-affinity) with,
    /// <br/>where co-located is defined as running on a node whose value of
    /// <br/>the label with key &lt;topologyKey&gt; matches that of any node on which
    /// <br/>a pod of the set of pods is running
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1PodAffinityTerm
    {
        ...
        /// <br/>The term is applied to the union of the namespaces listed in this field
        /// <br/>and the ones selected by namespaceSelector.
        /// <br/>null or empty namespaces list and null namespaceSelector means "this pod's namespace"
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>the labelSelector in the specified namespaces, where co-located is defined as running on a node
        /// <br/>whose value of the label with key topologyKey matches that of any node on which any of the
        /// <br/>selected pods is running.
        /// <br/>Empty topologyKey is not allowed.
        /// </summary>
    ...
    public partial class V1PodAntiAffinity
    {
        /// <summary>
        /// The scheduler will prefer to schedule pods to nodes that satisfy
        /// <br/>the anti-affinity expressions specified by this field, but it may choose
        /// <br/>a node that violates one or more of the expressions. The node that is
        /// <br/>most preferred is the one with the greatest sum of weights, i.e.
        /// <br/>for each node that meets all of the scheduling requirements (resource
        /// <br/>request, requiredDuringScheduling anti-affinity expressions, etc.),
        /// <br/>compute a sum by iterating through the elements of this field and adding
        /// <br/>"weight" to the sum if the node has pods which matches the corresponding podAffinityTerm; the
        /// <br/>node(s) with the highest sum are the most preferred.
        /// <br/>+optional
        ...
        /// <br/>scheduling time, the pod will not be scheduled onto the node.
        /// <br/>If the anti-affinity requirements specified by this field cease to be met
        /// <br/>at some point during pod execution (e.g. due to a pod label update), the
        /// <br/>system may or may not try to eventually evict the pod from its node.
        /// <br/>When there are multiple elements, the lists of nodes corresponding to each
        /// <br/>podAffinityTerm are intersected, i.e. all terms must be satisfied.
    ...
    /// <br/>those generated from DNSPolicy.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1PodDNSConfig
    {
        ...
        /// <br/>This will be appended to the base nameservers generated from DNSPolicy.
        /// <br/>Duplicated nameservers will be removed.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>This will be merged with the base options generated from DNSPolicy.
        /// <br/>Duplicated entries will be removed. Resolution options given in Options
        /// <br/>will override those that appear in the base DNSPolicy.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("options", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <br/>This will be appended to the base search paths generated from DNSPolicy.
        /// <br/>Duplicated search paths will be removed.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>container.securityContext take precedence over field values of PodSecurityContext.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1PodSecurityContext
    {
        ...
        /// <br/>Some volume types allow the Kubelet to change the ownership of that volume
        /// <br/>to be owned by the pod:
        /// <br/>
        /// <br/>1. The owning GID will be the FSGroup
        /// <br/>2. The setgid bit is set (new files created in the volume will be owned by FSGroup)
        /// <br/>3. The permission bits are OR'd with rw-rw----
        /// <br/>
        /// <br/>If unset, the Kubelet will not modify the ownership and permissions of any volume.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Uses runtime default if unset.
        /// <br/>May also be set in SecurityContext.  If set in both SecurityContext and
        /// <br/>PodSecurityContext, the value specified in SecurityContext takes precedence
        /// <br/>for that container.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>If true, the Kubelet will validate the image at runtime to ensure that it
        /// <br/>does not run as UID 0 (root) and fail to start the container if it does.
        /// <br/>If unset or false, no such validation will be performed.
        /// <br/>May also be set in SecurityContext.  If set in both SecurityContext and
        /// <br/>PodSecurityContext, the value specified in SecurityContext takes precedence.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Defaults to user specified in image metadata if unspecified.
        /// <br/>May also be set in SecurityContext.  If set in both SecurityContext and
        /// <br/>PodSecurityContext, the value specified in SecurityContext takes precedence
        /// <br/>for that container.
        /// <br/>+optional
        ...
        /// <br/>to the container's primary GID.  If unspecified, no groups will be added to
        /// <br/>any container.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>sysctls (by the container runtime) might fail to launch.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1PodSpec
    {
        ...
        /// <br/>StartTime before the system will actively try to mark it failed and kill associated containers.
        /// <br/>Value must be a positive integer.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Containers cannot currently be added or removed.
        /// <br/>There must be at least one container in a Pod.
        /// <br/>Cannot be updated.
        /// <br/>+patchMergeKey=name
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>environment variables, matching the syntax of Docker links.
        /// <br/>Optional: Defaults to true.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>pod to perform user-initiated actions such as debugging. This list cannot be specified when
        /// <br/>creating a pod, and it cannot be modified by updating the pod spec. In order to add an
        /// <br/>ephemeral container to an existing pod, use the pod's ephemeralcontainers subresource.
        /// <br/>This field is alpha-level and is only honored by servers that enable the EphemeralContainers feature.
        /// <br/>+optional
        /// <br/>+patchMergeKey=name
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>file if specified. This is only valid for non-hostNetwork pods.
        /// <br/>+optional
        /// <br/>+patchMergeKey=ip
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>If this option is set, the ports that will be used must be specified.
        /// <br/>Default to false.
        /// <br/>+k8s:conversion-gen=false
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>If not specified, the pod's hostname will be set to a system-defined value.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("hostname", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Hostname { get; set; }
        ...
        /// <br/>If specified, these secrets will be passed to individual puller implementations for them to use. For example,
        /// <br/>in the case of docker, only DockerConfig type secrets are honored.
        /// <br/>More info: https://kubernetes.io/docs/concepts/containers/images#specifying-imagepullsecrets-on-a-pod
        /// <br/>+optional
        /// <br/>+patchMergeKey=name
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>Init containers are executed in order prior to containers being started. If any
        /// <br/>init container fails, the pod is considered to have failed and is handled according
        /// <br/>to its restartPolicy. The name for an init container or normal container must be
        /// <br/>unique among all containers.
        /// <br/>Init containers may not have Lifecycle actions, Readiness probes, Liveness probes, or Startup probes.
        /// <br/>The resourceRequirements of an init container are taken into account during scheduling
        /// <br/>by finding the highest request/limit for each resource type, and then using the max of
        /// <br/>of that value or the sum of the normal containers. Limits are applied to init containers
        /// <br/>in a similar fashion.
        /// <br/>Init containers cannot currently be added or removed.
        /// <br/>Cannot be updated.
        /// <br/>More info: https://kubernetes.io/docs/concepts/workloads/pods/init-containers/
        /// <br/>+patchMergeKey=name
        /// <br/>+patchStrategy=merge
        /// </summary>
        ...
        /// <br/>the scheduler simply schedules this pod onto that node, assuming that it fits resource
        /// <br/>requirements.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("nodeName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <br/>Selector which must match a node's labels for the pod to be scheduled on that node.
        /// <br/>More info: https://kubernetes.io/docs/concepts/configuration/assign-pod-node/
        /// <br/>+optional
        /// <br/>+mapType=atomic
        /// </summary>
        ...
        /// <br/>priority of the pod. When Priority Admission Controller is enabled, it
        /// <br/>prevents users from setting this field. The admission controller populates
        /// <br/>this field from PriorityClassName.
        /// <br/>The higher the value, the higher the priority.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("priority", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <br/>"system-cluster-critical" are two special keywords which indicate the
        /// <br/>highest priorities with the former being the highest priority. Any other
        /// <br/>name must be defined by creating a PriorityClass object with that name.
        /// <br/>If not specified, the pod priority will be default or zero if there is no
        /// <br/>default.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>A pod is ready when all its containers are ready AND
        /// <br/>all conditions specified in the readiness gates have status equal to "True"
        /// <br/>More info: https://git.k8s.io/enhancements/keps/sig-network/580-pod-readiness-gates
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>to run this pod.  If no RuntimeClass resource matches the named class, the pod will not be run.
        /// <br/>If unset or empty, the "legacy" RuntimeClass will be used, which is an implicit class with an
        /// <br/>empty definition that uses the default runtime handler.
        /// <br/>More info: https://git.k8s.io/enhancements/keps/sig-node/585-runtime-class
        /// <br/>This is a beta feature as of Kubernetes v1.14.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>If not specified, the pod will be dispatched by default scheduler.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Deprecated: Use serviceAccountName instead.
        /// <br/>+k8s:conversion-gen=false
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>In Linux containers, this means setting the FQDN in the hostname field of the kernel (the nodename field of struct utsname).
        /// <br/>In Windows containers, this means setting the registry value of hostname for the registry key HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters to FQDN.
        /// <br/>If a pod does not have FQDN, this has no effect.
        /// <br/>Default to false.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>When this is set containers will be able to view and signal processes from other containers
        /// <br/>in the same pod, and the first process in each container will not be assigned PID 1.
        /// <br/>HostPID and ShareProcessNamespace cannot both be set.
        /// <br/>Optional: Default to false.
        /// <br/>+k8s:conversion-gen=false
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>If not specified, the pod will not have a domainname at all.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Value must be non-negative integer. The value zero indicates stop immediately via
        /// <br/>the kill signal (no opportunity to shut down).
        /// <br/>If this value is nil, the default grace period will be used instead.
        /// <br/>The grace period is the duration in seconds after the processes running in the pod are sent
        /// <br/>a termination signal and the time when the processes are forcibly halted with a kill signal.
        /// <br/>Set this value longer than the expected cleanup time for your process.
        ...
        /// <br/>domains. Scheduler will schedule pods in a way which abides by the constraints.
        /// <br/>All topologySpreadConstraints are ANDed.
        /// <br/>+optional
        /// <br/>+patchMergeKey=topologyKey
        /// <br/>+patchStrategy=merge
        /// <br/>+listType=map
        /// <br/>+listMapKey=topologyKey
        /// <br/>+listMapKey=whenUnsatisfiable
        /// </summary>
        ...
        /// <br/>+optional
        /// <br/>+patchMergeKey=name
        /// <br/>+patchStrategy=merge,retainKeys
        /// </summary>
    ...
    public partial class V1PortworxVolumeSource
    {
        ...
        /// <br/>Must be a filesystem type supported by the host operating system.
        /// <br/>Ex. "ext4", "xfs". Implicitly inferred to be "ext4" if unspecified.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string FsType { get; set; }
    ...
    /// <br/>(i.e. it's a no-op). A null preferred scheduling term matches no objects (i.e. is also a no-op).
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>alive or ready to receive traffic.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1Probe
    {
        ...
        /// <br/>Defaults to 3. Minimum value is 1.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Default to 10 seconds. Minimum value is 1.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Defaults to 1. Must be 1 for liveness and startup. Minimum value is 1.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>a termination signal and the time when the processes are forcibly halted with a kill signal.
        /// <br/>Set this value longer than the expected cleanup time for your process.
        /// <br/>If this value is nil, the pod's terminationGracePeriodSeconds will be used. Otherwise, this
        /// <br/>value overrides the value provided by the pod spec.
        /// <br/>Value must be non-negative integer. The value zero indicates stop immediately via
        /// <br/>the kill signal (no opportunity to shut down).
        /// <br/>This is a beta field and requires enabling ProbeTerminationGracePeriod feature gate.
        /// <br/>Minimum value is 1. spec.terminationGracePeriodSeconds is used if unset.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("terminationGracePeriodSeconds", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public long? TerminationGracePeriodSeconds { get; set; }
        ...
        /// <br/>Defaults to 1 second. Minimum value is 1.
        /// <br/>More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("timeoutSeconds", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class V1QuobyteVolumeSource
    {
        ...
        /// <br/>specified as a string as host:port pair (multiple entries are separated with commas)
        /// <br/>which acts as the central registry for volumes
        /// </summary>
        ...
        /// <br/>Used with dynamically provisioned Quobyte volumes, value is set by the plugin
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Defaults to serivceaccount user
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("user", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string User { get; set; }
    ...
    public partial class V1RBDVolumeSource
    {
        ...
        /// <br/>Tip: Ensure that the filesystem type is supported by the host operating system.
        /// <br/>Examples: "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#rbd
        /// <br/>TODO: how do we prevent errors in the filesystem from compromising the machine
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("fsType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <br/>More info: https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it
        /// </summary>
        [Newtonsoft.Json.JsonProperty("image", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Image { get; set; }
        ...
        /// <br/>Default is /etc/ceph/keyring.
        /// <br/>More info: https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1ScaleIOVolumeSource
    {
        ...
        /// <br/>that is associated with this volume source.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("volumeName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string VolumeName { get; set; }
    ...
    public partial class V1SeccompProfile
    {
        ...
        /// <br/>The profile must be preconfigured on the node to work.
        /// <br/>Must be a descending path, relative to the kubelet's configured seccomp profile location.
        /// <br/>Must only be set if type is "Localhost".
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>projected volume as files using the keys in the Data field as the file names.
    /// <br/>Note that this is identical to a secret volume source without the default
    /// <br/>mode.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1SecretProjection
    {
        /// <summary>
        /// If unspecified, each key-value pair in the Data field of the referenced
        /// <br/>Secret will be projected into the volume as a file whose name is the
        /// <br/>key and content is the value. If specified, the listed keys will be
        /// <br/>projected into the specified paths, and unlisted keys will not be
        /// <br/>present. If a key is specified which is not present in the Secret,
        /// <br/>the volume setup will error unless it is marked optional. Paths must be
        /// <br/>relative and may not contain the '..' path or start with '..'.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>as files using the keys in the Data field as the file names.
    /// <br/>Secret volumes support ownership management and SELinux relabeling.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1SecretVolumeSource
    {
        ...
        /// Optional: mode bits used to set permissions on created files by default.
        /// <br/>Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511.
        /// <br/>YAML accepts both octal and decimal values, JSON requires decimal values
        /// <br/>for mode bits. Defaults to 0644.
        /// <br/>Directories within the path are not affected by this setting.
        /// <br/>This might be in conflict with other options that affect the file
        /// <br/>mode, like fsGroup, and the result can be other mode bits set.
        /// <br/>+optional
        ...
        /// <br/>More info: https://kubernetes.io/docs/concepts/storage/volumes#secret
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("secretName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SecretName { get; set; }
    ...
    /// <br/>are set, the values in SecurityContext take precedence.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1SecurityContext
    {
        ...
        /// <br/>privileges than its parent process. This bool directly controls if
        /// <br/>the no_new_privs flag will be set on the container process.
        /// <br/>AllowPrivilegeEscalation is true always when the container is:
        /// <br/>1) run as Privileged
        /// <br/>2) has CAP_SYS_ADMIN
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Processes in privileged containers are essentially equivalent to root on the host.
        /// <br/>Defaults to false.
        /// <br/>+optional
        /// </summary>
        ...
        /// The GID to run the entrypoint of the container process.
        /// <br/>Uses runtime default if unset.
        /// <br/>May also be set in PodSecurityContext.  If set in both SecurityContext and
        /// <br/>PodSecurityContext, the value specified in SecurityContext takes precedence.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("runAsGroup", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    /// <br/>(for example 3306) that the proxy listens on, and the selector that determines which pods
    /// <br/>will answer requests sent through the proxy.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    ...
    /// <br/>volume. This projection can be used to insert a service account token into
    /// <br/>the pods runtime filesystem for use against APIs (Kubernetes API Server or
    /// <br/>otherwise).
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1ServiceAccountTokenProjection
    {
        ...
        /// <br/>must identify itself with an identifier specified in the audience of the
        /// <br/>token, and otherwise should reject the token. The audience defaults to the
        /// <br/>identifier of the apiserver.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>account token. As the token approaches expiration, the kubelet volume
        /// <br/>plugin will proactively rotate the service account token. The kubelet will
        /// <br/>start trying to rotate the token if the token is older than 80 percent of
        /// <br/>its time to live or if the token is older than 24 hours.Defaults to 1 hour
        /// <br/>and must be at least 10 minutes.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1ServiceSpec
    {
        ...
        /// <br/>usually assigned randomly.  If an address is specified manually, is
        /// <br/>in-range (as per system configuration), and is not in use, it will be
        /// <br/>allocated to the service; otherwise creation of the service will fail.
        /// <br/>This field may not be changed through updates unless the type field is
        /// <br/>also being changed to ExternalName (which requires this field to be
        /// <br/>empty) or the type field is being changed from ExternalName (in which
        /// <br/>case this field may optionally be specified, as describe above).  Valid
        /// <br/>values are "None", empty string (""), or a valid IP address.  Setting
        /// <br/>this to "None" makes a "headless service" (no virtual IP), which is
        /// <br/>useful when direct endpoint connections are preferred and proxying is
        /// <br/>not required.  Only applies to types ClusterIP, NodePort, and
        /// <br/>LoadBalancer. If this field is specified when creating a Service of type
        /// <br/>ExternalName, creation will fail. This field will be wiped when updating
        /// <br/>a Service to type ExternalName.  If this field is not specified, it will
        /// <br/>be initialized from the clusterIP field.  If this field is specified,
        /// <br/>clients must ensure that clusterIPs[0] and clusterIP have the same
        /// <br/>value.
        /// <br/>
        /// <br/>Unless the "IPv6DualStack" feature gate is enabled, this field is
        /// <br/>limited to one value, which must be the same as the clusterIP field.  If
        /// <br/>the feature gate is enabled, this field may hold a maximum of two
        /// <br/>entries (dual-stack IPs, in either order).  These IPs must correspond to
        /// <br/>the values of the ipFamilies field. Both clusterIPs and ipFamilies are
        /// <br/>governed by the ipFamilyPolicy field.
        ...
        /// <br/>service, and is gated by the "IPv6DualStack" feature gate.  This field
        /// <br/>is usually assigned automatically based on cluster configuration and the
        /// <br/>ipFamilyPolicy field. If this field is specified manually, the requested
        /// <br/>family is available in the cluster, and ipFamilyPolicy allows it, it
        /// <br/>will be used; otherwise creation of the service will fail.  This field
        /// <br/>is conditionally mutable: it allows for adding or removing a secondary
        /// <br/>IP family, but it does not allow changing the primary IP family of the
        /// <br/>Service.  Valid values are "IPv4" and "IPv6".  This field only applies
        /// <br/>to Services of types ClusterIP, NodePort, and LoadBalancer, and does
        /// <br/>apply to "headless" services.  This field will be wiped when updating a
        /// <br/>Service to type ExternalName.
        /// <br/>
        /// <br/>This field may hold a maximum of two entries (dual-stack families, in
        /// <br/>either order).  These families must correspond to the values of the
        /// <br/>clusterIPs field, if specified. Both clusterIPs and ipFamilies are
        /// <br/>governed by the ipFamilyPolicy field.
        /// <br/>+listType=atomic
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1StorageOSVolumeSource
    {
        ...
        /// <br/>names are only unique within a namespace.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("volumeName", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string VolumeName { get; set; }
        ...
        /// <br/>namespace is specified then the Pod's namespace will be used.  This allows the
        /// <br/>Kubernetes name scoping to be mirrored within StorageOS for tighter integration.
        /// <br/>Set VolumeName to any name to override the default behaviour.
        /// <br/>Set to "default" if you are not using namespaces within StorageOS.
        /// <br/>Namespaces that do not pre-exist within StorageOS will be created.
        /// <br/>+optional
        /// </summary>
    ...
    /// <br/>the triple &lt;key,value,effect&gt; using the matching operator &lt;operator&gt;.
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1Toleration
    {
        ...
        /// <br/>If the key is empty, operator must be Exists; this combination means to match all values and all keys.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("key", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Key { get; set; }
        ...
        /// <br/>of effect NoExecute, otherwise this field is ignored) tolerates the taint. By default,
        /// <br/>it is not set, which means tolerate the taint forever (do not evict). Zero and
        /// <br/>negative values will be treated as 0 (evict immediately) by the system.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>If the operator is Exists, the value should be empty, otherwise just a regular string.
        /// <br/>+optional
        /// </summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Value { get; set; }
    ...
    public partial class V1TopologySpreadConstraint
    {
        ...
        /// <br/>When `whenUnsatisfiable=DoNotSchedule`, it is the maximum permitted difference
        /// <br/>between the number of matching pods in the target topology and the global minimum.
        /// <br/>For example, in a 3-zone cluster, MaxSkew is set to 1, and pods with the same
        /// <br/>labelSelector spread as 1/1/0:
        /// <br/>+-------+-------+-------+
        /// <br/> zone1 | zone2 | zone3 |
        /// <br/>+-------+-------+-------+
        /// <br/>   P   |   P   |       |
        /// <br/>+-------+-------+-------+
        /// <br/>if MaxSkew is 1, incoming pod can only be scheduled to zone3 to become 1/1/1;
        /// <br/>scheduling it onto zone1(zone2) would make the ActualSkew(2-0) on zone1(zone2)
        /// <br/>violate MaxSkew(1).
        /// <br/>if MaxSkew is 2, incoming pod can be scheduled onto any zone.
        /// <br/>When `whenUnsatisfiable=ScheduleAnyway`, it is used to give higher precedence
        /// <br/>to topologies that satisfy it.
        /// <br/>It's a required field. Default value is 1 and 0 is not allowed.
        /// </summary>
        ...
        /// <br/>and identical values are considered to be in the same topology.
        /// <br/>We consider each &lt;key, value&gt; as a "bucket", and try to put balanced number
        /// <br/>of pods into each bucket.
        /// <br/>It's a required field.
        /// </summary>
        [Newtonsoft.Json.JsonProperty("topologyKey", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string TopologyKey { get; set; }
    ...
    /// <br/>typed referenced object inside the same namespace.
    /// <br/>+structType=atomic
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "13.16.1.0 (NJsonSchema v10.7.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class V1TypedLocalObjectReference
    {
        ...
        /// <br/>If APIGroup is not specified, the specified Kind must be in the core API group.
        /// <br/>For any other third-party types, APIGroup is required.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1Volume
    {
        ...
        /// <summary>
        /// Volume's name.
        /// <br/>Must be a DNS_LABEL and unique within the pod.
        /// <br/>More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names
        /// </summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Name { get; set; }
    ...
    public partial class V1VolumeMount
    {
        ...
        /// <br/>Behaves similarly to SubPath but environment variable references $(VAR_NAME) are expanded using the container's environment.
        /// <br/>Defaults to "" (volume's root).
        /// <br/>SubPathExpr and SubPath are mutually exclusive.
        /// <br/>+optional
        /// </summary>
    ...
    public partial class V1WindowsSecurityContextOptions
    {
        ...
        /// <br/>(https://github.com/kubernetes-sigs/windows-gmsa) inlines the contents of the
        /// <br/>GMSA credential spec named by the GMSACredentialSpecName field.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>This field is alpha-level and will only be honored by components that enable the
        /// <br/>WindowsHostProcessContainers feature flag. Setting this field without the feature
        /// <br/>flag will result in errors when validating the Pod. All of a Pod's containers must
        /// <br/>have the same effective HostProcess value (it is not allowed to have a mix of HostProcess
        /// <br/>containers and non-HostProcess containers).  In addition, if HostProcess is true
        /// <br/>then HostNetwork must also be set to true.
        /// <br/>+optional
        /// </summary>
        ...
        /// <br/>Defaults to the user specified in image metadata if unspecified.
        /// <br/>May also be set in PodSecurityContext. If set in both SecurityContext and
        /// <br/>PodSecurityContext, the value specified in SecurityContext takes precedence.
        /// <br/>+optional
        /// </summary>
