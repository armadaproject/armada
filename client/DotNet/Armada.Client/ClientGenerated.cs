...
namespace GResearch.Armada.Client
{
    ...
    public partial class ApiJob 
    {
        ...
        [Newtonsoft.Json.JsonProperty("disableUtilisation", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? DisableUtilisation { get; set; }
