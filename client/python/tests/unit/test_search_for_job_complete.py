...
def test_succeded_event():
    ...
    assert job_complete[1] == f"Armada job:id test:id succeeded"
...
def test_failed_event():
    ...
    assert job_complete[1] == f"Armada job:id test:id failed\nfailed with reason test fail"
...
def test_cancelling_event():
    ...
    assert job_complete[1] == f"Armada job:id test:id cancelling"
...
def test_cancelled_event():
    ...
    assert job_complete[1] == f"Armada job:id test:id cancelled"
...
def test_terminated_event():
    ...
    assert job_complete[1] == f"Armada job:id test:id terminated"
